        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-plus fa-fw"></i><?= esc($admin_heading) ?> <a
                    href="<?php echo site_url('admin/listemailtemplates'); ?>" class="pull-right"><i
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                         ...
                         <!--<div class="form-group">
                            <label for="Cc"><?php //echo "Cc"; ?>  </label><input type="text"
                                                                                                                                      class="form-control" name="cc"
                                                                                                                                      value="<?php //echo set_value('cc', isset($templatedatas) ? $templatedatas[0]->cc : ''); ?>"
                                                                                                                                      >
                        </div>-->
                        <div class="form-group">
