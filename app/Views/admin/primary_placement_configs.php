        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="overflow:hidden">
                ...
                <div class="pull-right">
                    <div class="btn-group">
                        <button type="button" class="btn btn-success wpsc_button" style="pointer-events: all;" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#addPrimaryPlacementModal" id="addPrimaryPlacement"><em class="fa fa-plus fa-fw"></em>Add New</button>
                    </div>
            	</div>
            </div>
