	...
	<div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <em class="fa fa-tasks fa-fw"></em><?php echo lang('app.language_admin_tds_cefr_ability'); ?>
            </div>       
            <div class="panel-body">
            ...
            <?php } ?> 
                <img class="loading" style="display: none;width:25px;height:25px;margin-top:2%;margin-left:50%;" src="<?php echo base_url('public/images/loading.gif'); ?>" alt="..." />
                <?php if(!empty($cefr_ability_current)){ ?>
                <div id="content_load">
                    <div class="form-group">
