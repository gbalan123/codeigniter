...
<div class="row">
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading"><em class="fa fa-plus fa-fw"></em><?= esc($admin_heading) ?>
                                       ...
                                       $times = array(      '0' => '00:00',
                                        ...
                                        ?>   
                                               ...
                                               <div class="form-group">
                                                   <label for="name"><em class="fa fa-link">&nbsp;</em><?php echo 'URL'; ?>:</label> 
						...
						<div class="form-group">
       							<label for="name"><?php echo lang('app.language_admin_first_run'); ?>:</label> 
                                                        ...
                                                        <select name="first_run" class="form-control">
                                                            ...
                                                            <?php endforeach; ?>
                                                        </select> <span class="input-group-addon"><em class="fa fa-clock-o"></em>&nbsp;hours</span>
                                                        </div>
                                                </div>
                                                <div class="form-group">
       							...
       							<label for="name"><?php echo lang('app.language_admin_third_run'); ?>:</label> 
                                                        ...
                                                        <select name="third_run" class="form-control">
                                                            ...
                                                            <span class="input-group-addon"><em class="fa fa-clock-o"></em>&nbsp;hours</span>
                                                        </div>
                                                </div> 
                                                <div class="form-group">
