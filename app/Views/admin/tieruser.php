						...
						<legend style="font-size: 14px;">
							...
							<div class="form-group col-xs-12 clearfix" >
								...
								<input type="text"
									   ...
									   value="<?php echo(!$tieruser) ? '' : $tieruser->firstname ;?>"
									> 
							</div>
							<div class="form-group col-xs-12 clearfix" >
								...
								<input type="text"
									   ...
									   value="<?php echo(!$tieruser) ? '' : $tieruser->lastname ;?>"
									  >
							</div>
							<div class="form-group col-xs-12 clearfix" >
								...
								<input type="text"
									   ...
									   value="<?php echo(!$tieruser) ? '' : $tieruser->department ;?>"
									 >  
							</div>
							<div class="form-group col-xs-12 clearfix" >
								...
								<input type="text"
									   ...
									   value="<?php echo(!$tieruser) ? '' : $tieruser->email ;?>"
									  >
							</div>
							<div class="form-group col-xs-12 clearfix" >
