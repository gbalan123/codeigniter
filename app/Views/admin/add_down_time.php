    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading" style="padding: bottom 10px;px;">
                <i class="fa fa-building fa-fw"></i><?php echo lang('app.language_admin_downtime_list');?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading" style="padding: bottom 10px;px;">
                <i class="fa fa-building fa-fw"></i><?php echo lang('app.language_admin_downtime_ip_list');?>
                <div class="btn-group pull-right" style="margin-top:3px;">
