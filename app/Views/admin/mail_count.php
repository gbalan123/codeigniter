...
<div class="row">
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading"><i class="fa fa-envelope-o"></i><?php echo lang('app.language_admin_email_log_date_total'); ?> : <?php echo $success; ?> emails.</div>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="col- 12 pull-right" style="margin-bottom:4px;">
                     ...
                     <i class="fa fa-download fa-fw"></i><?php echo lang('app.language_admin_email_log_date_csv'); ?></button>
                     <?php }else{ ?>
