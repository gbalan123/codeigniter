                            ...
                            <legend style="font-size: 14px;">
                                <div class="row">
                                    <div class="form-group col-xs-6 clearfix">
                                        ...
                                        <input type="text" class="form-control" name="ip_address" id="ip_address" maxlength="120"  value="<?php echo(!$ip_data) ? '' : $ip_data['ip_address']; ?>" />	
                                    ...
                                    <div class="form-group col-xs-6 clearfix">
                                        ...
                                        <input type="text" class="form-control" name="ip_name" id="ip_name" maxlength="120"  value="<?php echo(!$ip_data) ? '' : $ip_data['ip_name']; ?>" />	
                                        <span style="float:right; margin-top: 5px; font-weight: bold">
                                    </div>
                                    <input type="hidden" name="id" value="<?php echo(!$ip_data) ? '' : $ip_data['id']; ?>"  />
                                </div>
                            </legend>
