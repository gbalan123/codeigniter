	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-plus fa-fw"></i><?= esc($admin_heading) ?><a href="<?php echo site_url('admin/listproducts'); ?>" class="pull-right"><i class="fa fa-tasks fa-fw"></i><?php echo lang('app.language_admin_list_products'); ?></a>
			</div>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="uploaded_csv_table_client">
				<!--<p>Uploaded CSV tabulated data</p>-->
			</div>
...
function completeFn(results)
{
	...
	var product_names 		  = [];
	var product_levels 		  = [];
        //var product_moodle_levels         = get_moodle_courses();
        
	var product_groups 		  = [ "A1", "A2", "B1", "B2" ];
	var product_progressions  = [];
	//alert(arguments[0].data[1]);
				...
				if(results != ""){
					...
					if(levelexists != -1 && levelexists > -1 && product_level != '' && e_levels!=1){
						product_errors.push('<span style="color:red;">&nbsp;&nbsp;<?php echo lang("app.language_admin_product_csv_level_column_unique_error"); ?></span>');
                                       ...
                                       /* var levelexistsmoodle = $.inArray( product_level, product_moodle_levels);
					if(levelexistsmoodle != -1 && levelexistsmoodle > -1 && product_level != ''){
						
					}else if(e_levels!=1){
                                            product_errors.push('<span style="color:red;">&nbsp;&nbsp;Course does not exist in Course Delivary Platform!</span>');
                                        }*/
					...
					//product_errors.push(groupexists);
...
function complete_after_previewFn(results)
{
	...
	for(var a=1;a<rows;a++){
		...
		if(levelexistsmoodle != -1 && levelexistsmoodle > -1 && product_level != ''){
                     ...
                     product_errors.push('Course not exists in CDP');
                }*/
		//product groups condition
		if(product_group == '' )
		{
