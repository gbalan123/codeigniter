        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-plus fa-fw"></i><?= esc($admin_heading) ?> <a
                    href="<?php echo site_url('admin/institutions'); ?>" class="pull-right"><i
                        class="fa fa-tasks fa-fw"></i><?php echo lang('app.language_admin_institutions_heading'); ?></a>
            </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row">	
                                <div class="form-group col-xs-6 clearfix" >
                                    ...
                                    <?php } else { ?>
                                        <select class="form-control" name="tier" id="tier" onchange="get_section(this.value)" <?php //echo (isset($institute) && $institute['tierId']!='') ?  'disabled' :''; 
                                                                                                                                ?>>
