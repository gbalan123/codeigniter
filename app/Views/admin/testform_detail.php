...
<div class="row">
	<div class="col-md-12">
		<div class="alert alert-danger" id="warning_message" style="display:none;">
			...
			<a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#update_practice_inactive" id="practice_update_add"  data-value=""><i class="fa fa-plus fa-fw"></i>Add Test</a>
		</div>
                    	...
                    	<fieldset>  
							...
							<div class="row">	
								<div class="form-group col-xs-6 clearfix">
									...
									<!-- <input type="text" <?php if(isset($test_data)){ echo 'disabled'; }?> class="form-control" name="form_id" id="form_id" value="<?php echo set_value('form_id', isset($test_data) ? $test_data['test_formid'] : ''); ?>" readonly /> -->
