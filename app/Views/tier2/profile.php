...
<div class="bg-lightgrey">
    <div class="container">
		...
		<div class="col-sm-12" style="margin-bottom:40px;">
			<div class="main_tab">
                            <p class="p20"><a href="<?php echo site_url('tier2/dashboard'); ?>"><span class="fa fa-long-arrow-left"></span> <?php echo lang('app.language_search_events_back_to_dash'); ?></a></p>
			</div>
									...
									<div class="tab-content">
										...
										<div class="row">
											<div class="col-sm-12 profile-form">
												<?php echo form_open('tier2/profile', array('role' => 'form bv-form', 'class' => 'form-horizontal', 'autocomplete' => 'off', 'method' => 'POST', 'id' => '', 'data-bv-feedbackicons-valid' => 'glyphicon glyphicon-ok', 'data-bv-feedbackicons-invalid' => "glyphicon glyphicon-remove", 'data-bv-feedbackicons-validating' => "glyphicon glyphicon-refresh")); ?>
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-xs-12">
														<input type="email" class="form-control" name="email" value="<?php echo $this->session->get('username'); ?>" placeholder=""  />
