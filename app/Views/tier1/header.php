...
<html lang="en">
  <head>
    ...
    <meta name="title" content="<?php echo (!empty($cmsvalue[0]->meta_title)) ? $cmsvalue[0]->meta_title : ""; ?>">
    <meta name="keywords" content="<?php echo (!empty($cmsvalue[0]->meta_keywords)) ? $cmsvalue[0]->meta_keywords : ""; ?>">
    <meta name="description" content="<?php echo (!empty($cmsvalue[0]->meta_description)) ? $cmsvalue[0]->meta_description : ""; ?>">
