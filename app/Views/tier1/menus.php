...
<div class="bg-white">
    <div class="container-fluid nopadding">
        <div class="navbar-header">
            <div class="logo"> 
                <a href="<?php echo ($this->acl_auth->logged_in()) ? site_url('tier1/dashboard') : site_url(); ?>" class="navbar-brand"><img src="<?php echo base_url() . '/public/images/logo_new.svg'; ?>" class="img-responsive" alt="CATs Logo" /></a> 
            </div>
        </div>
        <div class="langeage-box">
            ...
            <?php if ($this->acl_auth->logged_in()) { 
                ...
                <div class="dropdown user_logout" id="userDropdown">
                    ...
                    <div class="dropdown-menu  dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="<?php echo site_url('tier1/dashboard'); ?>"><span class="fa fa-dashboard " style="color: #fff;"></span>&nbsp;<?php echo lang('app.language_dashboard'); ?></a>
						<a class="dropdown-item" href="<?php echo site_url('tier1/profile'); ?>"><span class="fa fa-user " style="color: #fff;"></span>&nbsp;<?php echo lang('app.site_label_drop_profile'); ?></a>
