...
<div class="bg-lightgrey">
    <div class="container">
		...
		<div class="tier institution_page">
			<h1 class="user_name"><?php echo lang('app.language_tier1_dashboard_welcome'); ?> - <?php echo ucfirst($this->session->get('user_firstname')." ".$this->session->get('user_lastname')); ?></h1>
			<div class="institution_tab nav_dashboard" style="overflow:hidden;">
				<!-- Nav tabs -->
				<ul class="nav nav-tabs" role="tablist">
					<li id="tab_ord" role="presentation" class="active"><a href="#tier1_option" id="tab_tier1" aria-controls="home" role="tab" data-toggle="tab">Choose your option</a></li>
				</ul>
				<div class="institution_content">
				<div role="tabpanel" class="tab-pane  active" id="tier1_option">
					<div class="row" style="margin:0px;">
						<div class="pull-left radio_btn">
							<input type="radio" name="tier1_option" id="view_report" value="report" data-bv-field="product_type">
							<label for="view_report" style="font-weight: normal; margin-left: 10px; font-size: 15px;">View tier 1 reports</label>
						</div>
					</div>
					<div class="row" style="margin:0px;">
						<div class="pull-left radio_btn">
							<input type="radio" name="tier1_option" id="administer_institute" value="administer" <?php echo $enable_btn; ?> >
					...
					<form class="form-inline" action="<?php echo site_url('tier1/dashboard'); ?>" id="searchForm_tier">
					...
					<div class="col-sm-12">
						<div class="table-responsive view-tokens mt40">
							<table class="table table-bordered institution_table">
								...
								<tbody>
									<?php if(isset($institute_data[$institute_users]) && count($institute_data[$institute_users]) > 0){?>
						...
						<div class="institution_pagination">
							<nav class="text-right">
								...
								<?= $institute_data['pagination']->links('pagination_tier1_institution_list') ?>
								<?php endif ?> 
							</nav>
						</div>
					</div>
