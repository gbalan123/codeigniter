									...
									<tbody>	
                                        ...
                                        <tr>
											...
											<?php } else if(isset($token->order_type) && $token->order_type == "benchmarking"){ ?>
                                                ...
                                                <?php if(isset($token->audio_reponses) && ($token->audio_reponses == 1)) { ?>
                                                    <?php if($token->audio_available){?>
                                                        <a href="<?php if(isset($token->url) && !empty($token->url)){ echo $token->url; }?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Listen to Stepcheck test audio responses (opens in a new tab)"><em class="bi bi-volume-up-fill"></em></a> 
                                                    <?php }else{
                                                        echo @disable_icon();
                                                        }?>  
                                                <?php } ?>	
