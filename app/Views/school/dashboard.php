						...
						<thead>
							<tr>
								...
								<th><?php if (!empty($class_learners) && count($class_learners) > 1) {  
										...
										<?php echo anchor(current_url() ."?".$without_email['0']. "&name=" . (($this->request->getGet('name') == 'ASC') ? 'DESC' : 'ASC'), lang('app.language_teacher_toknpage_email_username') . (($this->request->getGet('name') == 'ASC') ? '&nbsp;<em class="fa fa-arrow-up" aria-hidden="true"></em>' : '&nbsp;<em class="fa fa-arrow-down" aria-hidden="true"></em>'), array('style' => 'color:white;')); ?>
									<?php } else { ?>
														...
														<td>
															...
															<?php if ($token->productid < 10) {
																...
																<?php  } elseif(isset($token->practiceresults_tds) && !empty($token->practiceresults_tds['practice_test1']) && !empty($token->practiceresults_tds['practice_test1']['processed_data'])){?> 
																	...
																	<?php if($token->practiceresults_tds['practice_test1']['audio_available']){?>
																		<a href="<?php if(isset($token->practiceresults_tds['practice_test1']['url']) && !empty($token->practiceresults_tds['practice_test1']['url'])){ echo $token->practiceresults_tds['practice_test1']['url']; }?>" target="_blank"data-toggle="tooltip" data-placement="bottom" title="Listen to practice test audio responses (opens in a new tab)"><em class="bi bi-volume-up-fill"></em></a>
																		<?php }else{ 
																			echo @disable_icon();
																		}?>  
                                                        		<?php } ?>
															...
															<?php if ($token->productid < 10 && $token->practice_count > 1) {
																...
																<?php if(isset($token->practiceresults_tds['practice_test2']['audio_reponses']) && ($token->practiceresults_tds['practice_test2']['audio_reponses'] == 1)) { ?>
																		<?php if($token->practiceresults_tds['practice_test2']['audio_available']){?>
																			<a href="<?php if(isset($token->practiceresults_tds['practice_test1']['url']) && !empty($token->practiceresults_tds['practice_test1']['url'])){ echo $token->practiceresults_tds['practice_test2']['url']; }?>" target="_blank"data-toggle="tooltip" data-placement="bottom" title="Listen to practice test audio responses (opens in a new tab)"><em class="bi bi-volume-up-fill"></em></a>
																		<?php }else{ 
																			echo @disable_icon(); 
																			}?>  
                                                    			<?php } ?>
															...
															<?php if(isset($token->audio_reponses) && ($token->audio_reponses == 1)) { ?>
																<?php if($token->audio_available){ ?>
																		<a href="<?php if(isset($token->url) && !empty($token->url)){ echo $token->url; }?>" target="_blank" style="text-decoration:none" data-toggle="tooltip" data-placement="bottom" title="Listen to final test audio responses (opens in a new tab)"><em class="bi bi-volume-up-fill"></em></a>
													...
													<?php } else { ?>
															...
															<td style="/*white-space: nowrap;*/">
																<?php if(isset($token->TBR_token) && ($token->TBR_token != '') && ($token->is_used != 0)) { ?>
																	...
																	<?php if(isset($token->audio_reponses) && ($token->audio_reponses == 1)) { ?>
																		<?php if($token->audio_available){?>
																			<a style="text-decoration: underline;" href="<?php if(isset($token->url) && !empty($token->url)){ echo $token->url; }?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Listen to Stepcheck test audio responses (opens in a new tab)"><em class="bi bi-volume-up-fill"></em></a>
																		<?php }else{ 
																			echo @disable_icon();
																		 }?>     
																	<?php } ?>	
						...
						<div class="row">                       
							...
							<form action="<?php echo site_url('school/export_access_details'); ?>" method="POST">
								...
								<div class="col-sm-12 text-right mt30">
									...
									<button type="button" class="btn btn-sm btn-continue" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#addupdateModal_u13" id="addBtn_u13" ><em class ="fa fa-plus fa-fw"></em>Add</button>
									<?php }else{?>
									<button type="button" class="btn btn-sm btn-continue" data-toggle="modal" disabled> <em class="fa fa-plus fa-fw"></em>Add</button>
									<?php }?>
									
									<button type="button" class="btn btn-sm btn-continue" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#updateaddModal_u13" id="editBtn_u13"><em class="fa fa-edit fa-fw"></em>Edit</button>
								...
								<div class="table-responsive view-tokens mt40">
									<table class="table table-bordered institution_table">
										...
										<tr>
											<!-- Under 16 .. CHECK BOX -->
											<td align="center"><input type="checkbox" data-classstatus=""  name="u13_learner_ids[]" class="u13_learner_ids"  value="<?php echo  base64_encode($this->encrypter->encrypt($u13learner['id'])); ?>" <?php echo ($i == 0) ? 'checked="checked"' : '';  ?>  /></td>
												...
												if($u13learner['product_course_type'] === 'Higher'){
																									...
																									if(isset($u13learner['final_test']['audio_reponses']) && ($u13learner['final_test']['audio_reponses'] == 1)) { 
																										if($u13learner['final_test']['audio_available']){ ?>
																											 <a href="<?php if(isset($u13learner['final_test']['url']) && !empty($u13learner['final_test']['url'])){ echo $u13learner['final_test']['url']; }?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Listen to final test audio responses (opens in a new tab)"><em class="bi bi-volume-up-fill"></em></a>
																										 <?php }else{ 
																											echo @disable_icon();
																									      }
																									}
	...
	foreach ($distributors as $distributor) {
		...
		<?php endif; ?>
						...
						<div role="tabpanel" class="tab-pane <?php echo ($this->session->get('tab_teachers')) ? 'active' : ''; ?>" id="teachers">
							...
							?>
							<div class="col-sm-12 text-right mt30">
								<button type="button" class="btn btn-sm btn-continue"  data-toggle="modal"  data-backdrop="static" data-keyboard="false"  data-target="#addupdateModal" id="addBtn"><em class="fa fa-plus fa-fw"></em><?php echo lang('app.language_school_teachers_add_btn'); ?></button>
								<button type="button" <?php echo (empty($teachersData['teachers'])) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  data-toggle="modal" data-backdrop="static" data-keyboard="false"  data-target="#updateaddModal" id="editBtn"><em class="fa fa-edit fa-fw"></em><?php echo lang('app.language_school_teachers_viewedit_btn'); ?></button>
								<button type="button" <?php echo (empty($teachersData['teachers'])) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  id="deleteBtn"><em class="fa fa-trash-o fa-fw"></em><?php echo lang('app.language_school_teachers_delete_btn'); ?></button>
							</div>
							<div class="col-sm-12">
							<div class="table-responsive mt40">
								<table class="table table-bordered institution_table">
						...
						<div role="tabpanel" class="tab-pane <?php echo ($this->session->get('tab_venues')) ? 'active' : ''; ?>" id="venues">
							<div class="col-sm-12 text-right">
								...
								<button type="button" class="btn btn-sm btn-continue"  data-toggle="modal"  data-backdrop="static" data-keyboard="false"  data-target="#addupdateModalVenue" id="addBtnVenue"><em class="fa fa-plus fa-fw"></em><?php echo lang('app.language_distributor_add'); ?></button>
								<?php }else{ ?>
								<button type="button" disabled class="btn btn-sm btn-continue" id="addBtnVenue"><em class="fa fa-plus fa-fw"></em><?php echo lang('app.language_distributor_add'); ?></button>
								<?php } ?>
								<button type="button" <?php echo (empty($venueData['results'])) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  data-toggle="modal" data-backdrop="static" data-keyboard="false"  data-target="#updateaddModalVenue" id="editBtnVenue"><em class="fa fa-edit fa-fw"></em><?php echo lang('app.language_distributor_edit'); ?></button>
								<button type="button" <?php echo (empty($venueData['results'])) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  id="deleteBtnVenue"><em class="fa fa-trash-o fa-fw"></em><?php echo lang('app.language_distributor_delete'); ?></button>
							</div>
							<div class="col-sm-12">
							<div class="table-responsive mt40">
								<table class="table table-bordered institution_table">
					   ...
					   <div role="tabpanel" class="tab-pane <?php echo ($this->session->get('tab_events')) ? 'active' : ''; ?>" id="events">
							<div class="col-sm-12 text-right">
								...
								<?php if(((in_array('1', $institute_courseTypes))|| (in_array('2', $institute_courseTypes)) || (in_array('3', $institute_courseTypes)))){?>
								<button type="button"<?php echo ($test_events_data['venues'] == 0) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  data-toggle="modal"  data-backdrop="static" data-keyboard="false"  data-target="#addModalEvents" id="addBtnEvents"><em class="fa fa-plus fa-fw"></em><?php echo lang('app.language_school_events_add_btn'); ?></button>
								<?php }else{ ?>
								<button type="button" disabled class="btn btn-sm btn-continue" id="addBtnEvents"><em class="fa fa-plus fa-fw"></em><?php echo lang('app.language_school_events_add_btn'); ?></button>
								<?php } ?>
								<button type="button" <?php echo (empty($test_events_data['results'])) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  data-toggle="modal" data-backdrop="static" data-keyboard="false"  data-target="#updateModalEvents" id="editBtnEvents"><em class="fa fa-edit fa-fw"></em><?php echo lang('app.language_school_events_viewedit_btn'); ?></button>
								<button type="button" <?php echo (empty($test_events_data['results'])) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  id="deleteBtnEvents"><em class="fa fa-trash-o fa-fw"></em><?php echo lang('app.language_school_events_delete_btn'); ?></button>
							</div>
							<div class="col-sm-12">
								<div class="table-responsive mt40">
									<table class="table table-bordered institution_table">
            ...
            <div class="modal-content" >
                ...
                <div class="modal-header" style="border-bottom: 0px solid #e5e5e5;">
                    ...
                    <h4 class="modal-title"
                        ...
                        &nbsp;<img alt="loading" class="loading_main" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" /></h4>
                </div>
                <div class="modal-body" >
        ...
        <div class="modal-dialog modal-xs">
            <div class="modal-content" >
                <div class="modal-header" style="border-bottom: 0px solid #e5e5e5;">
                    <button type="button" class="close" data-dismiss="modal"
                            aria-hidden="true">&times;</button>
                    <h4 class="modal-title" style="font-weight: bold; text-align: center;">&nbsp;<img alt="" class="loading_main" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
                    </h4>
                </div>
                <div class="modal-body" >
                        <div class="modal-footer" style="border-top: 0px solid #e5e5e5;"></div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" >
                <div class="modal-header" style="border-bottom: 0px solid #e5e5e5;">
                    <button type="button" class="close" data-dismiss="modal"
                            aria-hidden="true">&times;</button>
                    <h4 class="modal-title" style="font-weight: bold; text-align: center;">&nbsp;<img alt="loading" class="loading_main" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
                    </h4>
                </div>
                <div class="modal-body" >
...
<div class="container">
    <div id="addModalEvents" class="modal fade" role="dialog" >
        <div class="modal-dialog modal-xs">
            <div class="modal-content" >
                <img alt="" class="loading_main" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
                <div class="modal-header" style="border-bottom: 0px solid #e5e5e5;">
                    <button type="button" class="close" data-dismiss="modal"
                            aria-hidden="true">&times;</button>
                    <h4 class="modal-title"
...
<div id="history_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo lang('app.language_school_learners_history'); ?>&nbsp;<img alt="loading" class="loading_history" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" /></h4>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content" >
            <div class="modal-header" style="border-bottom: 0px solid #e5e5e5;">
                <button type="button" class="close" data-dismiss="modal"
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" style="font-weight: bold;"><?php echo lang('app.language_school_u13learner_title'); ?>&nbsp;<img alt="loading" class="loading_main" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
                </h4>
            </div>
            <div class="modal-body" >
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <em class="fa fa-plus fa-fw"></em><?php echo lang('app.language_school_add_u13learner'); ?>
                            </div>
