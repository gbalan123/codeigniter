									...
									<div class="tab-content">
										...
										<div class="row">
											<div class="col-sm-12 profile-form">
												<?php echo form_open('school/profile', array('role' => 'form bv-form', 'class' => 'form-horizontal', 'autocomplete' => 'off', 'method' => 'POST', 'id' => '', 'data-bv-feedbackicons-valid' => 'glyphicon glyphicon-ok', 'data-bv-feedbackicons-invalid' => "glyphicon glyphicon-remove", 'data-bv-feedbackicons-validating' => "glyphicon glyphicon-refresh")); ?>
												<div class="form-group">
													...
													<div class="col-sm-6 col-xs-12">
														<input type="text" class="form-control" name="firstname" value="<?php echo set_value('firstname', isset($profile) ? $profile[0]->firstname : ''); ?>"
															   placeholder=""  />
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-xs-12">
														<input type="text" class="form-control" name="secondname" value="<?php echo set_value('secondname', isset($profile) ? $profile[0]->lastname : ''); ?>"
															   placeholder=""  />
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-xs-12">
														<input type="email" class="form-control" name="email" value="<?php echo set_value('email', $this->session->get('username')); ?>"
															   placeholder=""  />
												...
												<div class="col-sm-12 changepass-form">
													...
													<div class="form-group">
														...
														<div class="col-sm-6 col-xs-12">
															...
															<?php if($this->validation->getError('current_password')){?> <p><?php echo $this->validation->getError('current_password') ?></p>
															<?php  } ?>
															</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-6 col-xs-12">
															...
															<?php if($this->validation->getError('new_password')){?> <p><?php echo $this->validation->getError('new_password') ?></p>
															<?php  } ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-6 col-xs-12">
															...
															<?php if($this->validation->getError('confirm_new_password')){?> <p><?php echo $this->validation->getError('confirm_new_password') ?></p>
															<?php  } ?>
