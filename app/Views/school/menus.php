...
<div class="bg-white">
    <div class="container-fluid nopadding">
		...
		<div class="switch_accounts" style="margin: 25px 30px; display: block; float: right;">
			...
			<button type="button" class="btn btn-sm btn-continue pull-right" id="tier_switch_account"><em class="fa fa-exchange " style="font-size: 19px;margin-right: 10px;vertical-align: middle;"></em>Switch Accounts</button>	
		</div>
		<?php }?>
