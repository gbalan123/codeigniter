...
<html lang="en">
	...
	<body>
	    <section>
            <!-- overall bg -->
    	    <div class="bg">
            	<img alt="" src="<?php echo base_url('public/images/nature_bg.png'); ?>">
        	</div>
        	...
        	<div class="content_area">
	            <div> 
            	    ...
            	    <div class="left_content">
                    	<div class="logo">
	                        <img alt="" src="<?php echo base_url('public/images/cats_logo_pdf.png'); ?>">
                    	</div>
                    	<div class="profile_area">
	                        <div class="bg">
                            	<img alt="" src="<?php echo base_url('public/images/blue_bg.png'); ?>">
                        	</div>
                        	<table>
        						<tr>
                        	...
                        	<?php
                        	    ...
                        	    if($results['userDetails']['start_date_time']  != NULL){
                        	       $date_of_exam = date('d F Y', strtotime($results['date_exam_event']));
                				    ...
                				    $date_of_exam = date('d F Y', strtotime($results['userDetails']['result_date']));
                				}
            				?>
                	...
                	<div class="right_content">
	                    <div class="balloon_area">
                        	<div class="balloon_top">
	                            <img alt="" src="<?php echo base_url('public/images/balloon_top.png'); ?>" width="100%">
                        	</div>
                        	<div class="balloon_bottom">
	                            <div class="qr_code_area">
                                	...
                                	<div class="qr_pic"> <img alt="" src="<?php echo @image_png($parts[0],$parts[1],'qrcodes'); ?>"></div>
                                	<p><a href="#"><?php echo $results['google_url']; ?></a></p>
                            	</div>	
                            	<div class="balloon_bottom_bg">
	                                <img alt="" src="<?php echo base_url('public/images/balloon_bottom.png'); ?>" width="100%">
                            	</div>
                        	</div>
                    	</div>
                    	<div class="score_area">
	                        <div>
                            	<img alt="" src="<?php echo base_url('public/images/wooden_board.png'); ?>" width="100%">
                            	<div class="score">
	                                <p>Overall Score</p>
                	...
                	<div class="comments_area">
                    	...
                    	<table>
	                        <tbody>
                            	<tr>
	                                <td class="cartoon">
                                    	<img alt="" src="<?php echo base_url('public/images/boy.png'); ?>">
                                	</td>
                                        	...
                                        	<tbody>
	                                            <tr>
                                                	<td class="comment_arrow">
	                                                    <img alt="" src="<?php echo base_url('public/images/left_arrow.png'); ?>" width="100%">
                                                	</td>
                                                	<td class="comment_container">
                                                    	...
                                                    	<div class="bg">
	                                                        <img alt="" src="<?php echo base_url('public/images/white_bg.png'); ?>">
                                                    	</div>
                                                	</td>
                                            	</tr>
                                        	</tbody>
                    	...
                    	<table>
	                        <tbody>
                            	<tr>	
	                                    ...
	                                    <table>
                                        	<tbody>
	                                            <tr>	
                                                	...
                                                	<td class="comment_arrow">
	                                                    <img alt="" src="<?php echo base_url('public/images/right_arrow.png'); ?>" width="100%">
                                                	</td>
                                            	</tr>
                                        	</tbody>
                                    	</table>
                                	...
                                	<td class="cartoon">
	                                    <img alt="" src="<?php echo base_url('public/images/girl_1.png'); ?>">
                                	</td>
                            	</tr>
                        	</tbody>
                    	</table>
                    	...
                    	<table>
	                        <tbody>
                            	<tr>
	                                <td class="cartoon">
                                    	<img alt="" src="<?php echo base_url('public/images/girl_2.png'); ?>">
                                	</td>
                                	<td class="cartoon_comments_area">
	                                    <table>
                                        	<tbody>
