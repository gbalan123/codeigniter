...
<?php } ?>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        <p style="font-size: 15px;float:left;width:25%;margin-top: 20px;">Total capacity:&nbsp;<span><strong><?php echo $event_capacity; ?></strong></span></p>
                                        <p style="font-size: 15px;float:left;width:25%;margin-top: 20px;">Allocated:&nbsp;<span><strong><?php echo $learner_allocated; ?></strong></span></p>
                                        <p style="font-size: 15px;float:left;width:25%;margin-top: 20px;">Available:&nbsp;<span><strong><?php echo $allocation_available; ?></strong></span></p>
