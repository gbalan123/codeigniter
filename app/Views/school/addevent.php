    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-plus fa-fw"></i><?php echo lang('app.language_school_event_add_test_title'); ?>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group" style="margin-left:20px;">
                                            ...
                                            <li>
                                                <label>
                                                    <?php if ($group_name == "Primary") { ?>
                                                        <b style ="<?php echo (isset($eligible_version) && in_array($val, $eligible_version) ? '' : $css); ?>"> <input type="checkbox" name="product_group_values[]" value= "<?php echo $val; ?>" <?php echo (isset($eligible_version) && in_array($val, $eligible_version) ? '' : 'disabled'); ?>></input><?php echo " " . $val_name; ?>
                            ...
                            <?php //echo form_error('productGroup_id'); ?>
                        ...
                        <div class="form-group ">
                            ...
                            <!--<input type="text" class="form-control" name="notes" id="notes" value="<?php echo set_value('notes'); ?>" />	-->
...
<script type="text/javascript">
    $(function () {
        ...
        $("#datetimepicker1").on("dp.change dp.show", function (e) {
            ...
            //$('#event_add_form').bootstrapValidator('revalidateField', 'endtime');		
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.valid == false) {
                            ...
                            //$('#event_add_form').bootstrapValidator('defaultSubmit');
                            $.ajax({
                                type: "POST",
