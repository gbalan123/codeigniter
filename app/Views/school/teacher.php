    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-plus fa-fw"></i><?= esc($teacher_heading) ?>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 clearfix">
                        ...
                        <div class="form-group form-actions pull-right" style="clear:both;">
                            ...
                            <?php endif; ?>
                            <button type="submit" id="submitBtn" class="btn btn-sm btn-continue" ><?php echo lang('app.language_admin_institutions_submit_btn'); ?></button><img id="loading_in" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
                        </div>	 
                        <?php form_close(); ?>
                    </div>
