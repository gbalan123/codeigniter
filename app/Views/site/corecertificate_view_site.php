                ...
                <div class="col-sm-12">
                    ...
                    <div class="course-info mb20">
                        ...
                        <div class="row chart-body">
                            ...
                            <?php
                              /*  if(!empty($results['cefr_level']) && ($results['cefr_level'] != 'You have not achieved the pass level for the exam and we are unable to award you a result.') ) {
                                    $cefr_last = $rest = substr($results['cefr_level'], -1); 
                                    $cefr_first = $rest = substr($results['cefr_level'], 0,2); 
                                    $cefr_value = $cefr_first.'.'.$cefr_last;
                                    $results['cefr_level'] = $cefr_value;
                                }*/
                            ?>
                            <div class="col-sm-10  col-xs-6 ">
