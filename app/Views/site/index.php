...
<div class="home_page">
    <div class="container-fluid">
        <div class="home_banner">
            <div class="row">
                <img src="<?php echo base_url('public/images/home-banner.jpg'); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 text-center">
                        <a class="benchmark_verify" href="<?php echo site_url("pages/cats_stepcheck"); ?>">
                            <div>
                                <img src="<?php echo base_url('public/images/benchmark-verify.png'); ?>">
                                <p><b><?php echo lang('app.home_StepCheck'); ?></b>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 text-center">
                        <a class="about_course" href="<?php echo site_url("pages/cats_steps"); ?>">
                            <div>
                                <img src="<?php echo base_url('public/images/about-course.png'); ?>">
                                <p><b><?php echo lang('app.home_cats_steps'); ?></b>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 text-center">
                        <a class="information_edu" href="<?php echo site_url("pages/cats_solution"); ?>">
                            <div>
                                <img src="<?php echo base_url('public/images/information-edu.png'); ?>">
                                <p><b><?php echo lang('app.home_information_educator'); ?></b>
            ...
            <div class="cats_for">
                <div class="row">
                    <div class="col-sm-12 col-xs-12 text-center">
                        <!--<h2 class="text-center"><?php //echo lang('home_cats_difference'); ?></h2>-->
                        <img src="<?php echo base_url('public/images/cats_difference.png'); ?>">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="separator_icon">
                            <img src="<?php echo base_url('public/images/cats_separator.png'); ?>">
                            <hr class="separator">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="cats_logo_icon">
                                <img src="<?php echo base_url('public/images/cats_for_icon.png'); ?>">
