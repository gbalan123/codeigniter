<?php 
    ...
    $screenidDatas      = "screenid";
    $answersDatas       = "answers";
    $questionsDatas     = "questions";
    $questionaudioDatas = "questionaudio";
    $answeraudiosDatas  = "answeraudios";
    $questionnoDatas    = "questionno";
    $answer_Datas       = "answer_";
    $missinganswerDatas = "missinganswer";
    $tickImage          = base_url('public/images/tick.png');
    $crossImage         = base_url('public/images/cross.png');
?>
<style>
    .clickable{
        cursor: pointer;
...
<div class="modal fade" id="linearId" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog linear_test modal-lg" style="letter-spacing: 0.5px;">
                        ...
                        <div class="row mt100">
                            ...
                            <div class="sound-test-section quiz-start-headings" style="display:none;">
                                <div class="col-xs-10">
                                    ...
                                    <p><?php echo lang('app.language_linear_headphone_please_click_before'); ?> <img src="<?php echo base_url('public/images/play-small.png'); ?>" alt="..." /> <?php echo lang('app.language_linear_headphone_please_click_after'); ?></p>
                                </div>
                                <div class="col-xs-2">
                                    <img class="pull-right mt20 clearly-ok" src="<?php echo base_url('public/images/play-big.png'); ?>" onclick="play_clearly_sound();" alt="..."/>
                                </div>
                            ...
                            <section class="quiz" data-title="" data-subtitle="<?php echo lang('app.language_initial_message'); ?>">
                                ...
                                if (isset($linear)) {
                                    ...
                                    <?php foreach ($linear['screens'] as $lk => $lv): ?>
                                        <section class="question" name="" id="<?php echo $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId; ?>">
                                            <?php if ($lv['part'] == '1611'): ?>

                                                <div class="row mt100">
                                                    <div class="col-sm-4">
                                                        <label class="option">
                                                            <input type="radio" id="answer_<?php echo $lv[$screenidDatas]; ?>" name="answer_<?php echo $lv[$screenidDatas]; ?>" value="A">
                                                            <span class="checkmark_rec p1611"><img src="data:image/svg+xml;base64,<?php echo @image_efs(str_replace(".svg","",$lv[$questionsDatas][0][$answersDatas]['A'])); ?>" alt="opt-1"/></span>
                                                        </label></div>
                                                    <div class="col-sm-4">
                                                        <label class="option">
                                                            <input type="radio" id="answer_<?php echo $lv[$screenidDatas]; ?>" name="answer_<?php echo $lv[$screenidDatas]; ?>" value="B">
                                                            <span class="checkmark_rec p1611"><img src="data:image/svg+xml;base64,<?php echo @image_efs(str_replace(".svg","",$lv[$questionsDatas][0][$answersDatas]['B'])); ?>" alt="opt-2"/></span>
                                                        </label></div>
                                                    <div class="col-sm-4">
                                                        <label class="option">
                                                            <input type="radio" id="answer_<?php echo $lv[$screenidDatas]; ?>" name="answer_<?php echo $lv[$screenidDatas]; ?>" value="C">
                                                            <span class="checkmark_rec p1611"><img src="data:image/svg+xml;base64,<?php echo @image_efs(str_replace(".svg","",$lv[$questionsDatas][0][$answersDatas]['C'])); ?>" alt="opt-3"/></span>
                                                        </label></div>
                                                </div>

                                                <?php
                                                // Primary placement test - question start
                                                $sound_script_1611 = "<script>function play_sound_" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "(){
                                                                                                var counter_1611 = 0;
                                                                                                var maxIterations_1611 = 2;

                                                                                                var q_1611 = new Howl({
                                                                                                  src: ['" . @audio_efs(str_replace(".mp3","",$lv[$questionsDatas][0][$questionaudioDatas])) . "'],
                                                                                                  onend: function() {
                                                                                                     counter_1611++;
                                                ...
                                                <div class="row mt30">
                                                    <div class="col-sm-12 text-center">
                                                        <div class="question_img p1612">
                                                            <img src="data:image/svg+xml;base64,<?php echo @image_efs(str_replace(".svg","",$lv[$questionsDatas][0]['questionimage'])); ?>" alt="1612"/>
                                                        </div></div>
                                                </div>
                                                <div class="row mt50">
                                                    <div class="col-sm-4 text-center">
                                                        <label class="option-circle">
                                                            <input type="radio" id="answer_<?php echo $lv[$screenidDatas]; ?>" name="answer_<?php echo $lv[$screenidDatas]; ?>" value="A">
                                                            <span class="checkmark a_ans_playback_<?php echo $lv[$screenidDatas]; ?>">A</span>
                                                        </label></div>
                                                    <div class="col-sm-4 text-center">
                                                        <label class="option-circle">
                                                            <input type="radio" id="answer_<?php echo $lv[$screenidDatas]; ?>" name="answer_<?php echo $lv[$screenidDatas]; ?>" value="B">
                                                            <span class="checkmark b_ans_playback_<?php echo $lv[$screenidDatas]; ?>">B</span>
                                                        </label></div>
                                                    <div class="col-sm-4 text-center">
                                                        <label class="option-circle">
                                                            <input type="radio" id="answer_<?php echo $lv[$screenidDatas]; ?>" name="answer_<?php echo $lv[$screenidDatas]; ?>" value="C">
                                                            <span class="checkmark c_ans_playback_<?php echo $lv[$screenidDatas]; ?>">C</span>
                                                        </label></div>
                                                </div>
                                                <?php
                                                $sound_script_1612 = "<script>function play_sound_" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "(){
                                                                            var counter_1612 = 0;
                                                                            ...
                                                                            var q_1612 = new Howl({
                                                                              ...
                                                                              onend: function() {
                                                                                 counter_1612++;
                                                                                 var a_1612 = new Howl({
                                                                                 src: ['" . @audio_efs(str_replace(".mp3","",$lv[$questionsDatas][0][$answeraudiosDatas]['A'])) . "'],
                                                                                 onload: function() { 
                                                                                                   $('.a_ans_playback_" . $lv[$screenidDatas] . "').addClass('audio');
                                                                                 },    
                                                                                 onend: function() {
                                                                                         var b_1612 = new Howl({
                                                                                         src: ['" . @audio_efs(str_replace(".mp3","",$lv[$questionsDatas][0][$answeraudiosDatas]['B'])) . "'],
                                                                                         onload: function() { 
                                                                                                $('.a_ans_playback_" . $lv[$screenidDatas] . "').removeClass('audio');
                                                                                                $('.b_ans_playback_" . $lv[$screenidDatas] . "').addClass('audio');
                                                                                         },    
                                                                                         onend: function() {
                                                                                                 var c_1612 = new Howl({
                                                                                                                     src: ['" . @audio_efs(str_replace(".mp3","",$lv[$questionsDatas][0][$answeraudiosDatas]['C'])) . "'],
                                                                                                                     onload: function() {
                                                                                                                        $('.b_ans_playback_" . $lv[$screenidDatas] . "').removeClass('audio');
                                                                                                                        $('.c_ans_playback_" . $lv[$screenidDatas] . "').addClass('audio');
                                                                                                                     },    
                                                                                                                     onend: function() {
                                                                                                                                console.log('Finished iteration ' + counter_1612);
                                                                                                                                    if (counter_1612 == maxIterations_1612) {
                                                                                                                                            console.log('Last time!')
                                                                                                                                            q_1612.loop(false);
                                                                                                                                            $('.c_ans_playback_" . $lv[$screenidDatas] . "').removeClass('audio');
                                                                                                                                            timedCount();
                                                                                                                                    }else{
                                                                                                                                        $('.c_ans_playback_" . $lv[$screenidDatas] . "').removeClass('audio');
                                                                                                                                                var again = make_again();
                                            ...
                                            <?php if ($lv['part'] == '1613'): ?>
                                                    ...
                                                    <div class="col-sm-offset-4 col-sm-4">
                                                        <div class="">
                                                            <label class="check_btn-yes">
                                                                <input type="radio" id="<?php echo $answer_Datas . $lv[$screenidDatas]; ?>" name="<?php echo $answer_Datas . $lv[$questionsDatas][0][$questionnoDatas] . '_' . $lv[$screenidDatas]; ?>"  value="YES">
                                                                <span class="btn-yes"><img src="<?= $tickImage; ?>" alt="tick"></span>
                                                            </label>
                                                            <label class="check_btn-no">
                                                                <input type="radio" id="<?php echo $answer_Datas . $lv[$screenidDatas]; ?>" name="<?php echo $answer_Datas . $lv[$questionsDatas][0][$questionnoDatas] . '_' . $lv[$screenidDatas]; ?>"  value="NO">
                                                                <span class="btn-no"><img src="<?= $crossImage; ?>" alt="cross"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <?php
                                                $sound_script_1613 = "<script>function play_sound_" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "(){
                                                                                                var counter_1613 = 0;
                                            ...
                                            <?php if ($lv['part'] == '1622'): ?>
                                                ...
                                                <?php
                                                $sound_script_1622 = "<script>function play_sound_" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "(){
                                                                            var counter_1622 = 0;
                                                                            ...
                                                                            var q_1622 = new Howl({
                                                                              ...
                                                                              onend: function() {
                                                                                 counter_1622++;
                                                                                 var a_1622 = new Howl({
                                                                                 src: ['" . @audio_efs(str_replace(".mp3","",$lv[$answeraudiosDatas]['A'])) . "'],
                                                                                 onload: function() { 
                                                                                                   $('.a_ans_playback_" . $lv[$screenidDatas] . "').addClass('audio');
                                                                                 },    
                                                                                 onend: function() {
                                                                                         var b_1622 = new Howl({
                                                                                         src: ['" . @audio_efs(str_replace(".mp3","",$lv[$answeraudiosDatas]['B'])) . "'],
                                                                                         onload: function() { 
                                                                                                $('.a_ans_playback_" . $lv[$screenidDatas] . "').removeClass('audio');
                                                                                                $('.b_ans_playback_" . $lv[$screenidDatas] . "').addClass('audio');
                                                                                         },    
                                                                                         onend: function() {
                                                                                                 var c_1622 = new Howl({
                                                                                                                     src: ['" . @audio_efs(str_replace(".mp3","",$lv[$answeraudiosDatas]['C'])) . "'],
                                                                                                                     onload: function() {
                                                                                                                        $('.b_ans_playback_" . $lv[$screenidDatas] . "').removeClass('audio');
                                                                                                                        $('.c_ans_playback_" . $lv[$screenidDatas] . "').addClass('audio');
                                                                                                                     },    
                                            ...
                                            <?php if ($lv['part'] == '1627'): ?>
                                                <div class="row">
                                                    <div class="col-sm-12 qus_block text-center">
                                                        <h3><?php echo $lv[$questionsDatas][0]['question']; ?></h3>
                                                    </div>
                                                </div>
                                                <div class="row mt20">
                                                    <div class="col-sm-12 text-center">
                                                ...
                                                $timing_script_1627 = "<script>function play_timing_" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "(){
                                            ...
                                            <?php if ($lv['part'] == '1628'): ?>
                                                ...
                                                <div class="row mt50">
                                                    <div class="col-sm-12">
                                                        <div class="sys_qus_block text-center">
                                                            <p><?php echo $lv[$questionsDatas][0]['question']; ?></p>
                                                        </div></div>
                                                </div>
                                                <div class="row mt30">
                                                    <div class="col-sm-offset-4 col-sm-4">
                                                ...
                                                $timing_script_1628 = "<script>function play_timing_" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "(){
                                                                                ...
                                                                                var partId = ".$lv['part'].";
                                                                                var qusId = '" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "';
                                                                                if(partId == '1628'){  
                                            ...
                                            <?php if ($lv['part'] == '1629'): ?>
                                                ...
                                                if (!function_exists('set_select_box_1029')) {
                                                    ...
                                                    function set_select_box_1029($missing_answer, $screenid = false) {
                                                        ...
                                                        $attr = array('id' => $idname . $screenid, 'autocomplete' => "off");

                                                        foreach ($matches[0] as $key => $value) {

                                                            $explodeArr[$matches[0][$key]] = explode('/', str_replace(array_keys($replaceString), $replaceString, trim($matches[0][$key])));
                                                            $form_options[$matches[0][$key]] = '<span class="form-group" style="color:black;">' . form_dropdown($idname . $screenid, array_merge($plselect, array_combine(array_map('trim', $explodeArr[$matches[0][$key]]), array_map('trim', $explodeArr[$matches[0][$key]]))), '', $attr) . "</span>";
                                                        }
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 sys_qus_block text-center" style="display:inline-block; margin-top:8%; border-radius: 5px;">
                                                        <?php
                                                        $question[$missinganswerDatas] = $lv[$questionsDatas][0][$missinganswerDatas];
                                                        $screenid = $lv[$screenidDatas]
                                                        ?>
                                                        <ol>
                                                            <li style="list-style: none;"><p class="question1" style="text-align: left;"><?php echo str_replace(array_keys(set_select_box_1029($question[$missinganswerDatas])), set_select_box_1029($question[$missinganswerDatas], $screenid), $question[$missinganswerDatas]); ?></p></li>
                                                        </ol>
                                                    </div>
                                                </div>
                                                <?php
                                                $time_limit_1629 = (isset($lv['timelimit'])) ? $lv['timelimit'] + 1 : '15';
                                                $timing_script_1629 = "<script>function play_timing_" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "(){
        ...
        <?php if ($lv['part'] == '1630'): ?>
                                                ...
                                                <?php
                                                @preg_match('/\[(.*?)\]/', $lv[$questionsDatas][0][$missinganswerDatas], $output);
                                                ...
                                                isset($lv[$questionsDatas][0][$missinganswerDatas]) ? $lv[$questionsDatas][0][$missinganswerDatas] = preg_replace("/\[[^)]+\]/", "[$lengh_str]", $lv[$questionsDatas][0][$missinganswerDatas]) : '';


                                                preg_match('/\[(.*?)\]/', $lv[$questionsDatas][0][$missinganswerDatas], $textboxes);
                                                ...
                                                $whole_start_string = explode('[', $lv[$questionsDatas][0][$missinganswerDatas]);
                                                ...
                                                $whole_end_string = explode(']', $lv[$questionsDatas][0][$missinganswerDatas]);
                                                ...
                                                <div class="row mt50">
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-12 sys_qus_block form-inline text-center" style = "text-align:left; ">
                                                            <?php $screens_id = $lv[$screenidDatas] ?>
                                                ...
                                                $timing_script_1630 = "<script>function play_timing_" . $lv[$screenidDatas] . '_' . $lv['part'] . '_' . $qId . "(){
...
<?php } ?>
            ...
            <span class="countdowntimer_global" style="display:none;"><img alt="loading" src="<?php echo base_url('public/images/sandclock.gif'); ?>">&nbsp;&nbsp;<span id="countdowntimer" ></span>&nbsp;</span>
