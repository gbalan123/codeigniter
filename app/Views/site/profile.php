                                                    ...
                                                    <div class="nav_dashboard">
                                                        <div class="overflow_x">
                                                            ...
                                                            <li class="<?php echo ($this->session->get('tabprofile')) ? 'active' : ''; ?>"><a href="#profile_tab" data-toggle="tab"><?php echo lang('app.site_label_drop_profile') ?></a></li>
                                                                ...
                                                                <?php endif; ?> 
                                                                <li class="<?php echo ($this->session->get('tablang')) ? 'active' : ''; ?>"><a href="#lang_tab" data-toggle="tab"><?php echo lang('app.lsetting_panel_header_title'); ?> </a></li>
                                                        ...
                                                        <div class="tab-content">
                                                            <div id="profile_tab" class="tab-pane login fade <?php echo ($this->session->get('tabprofile')) ? 'in active' : ''; ?>">
                                                                <div class="row">
                                                                    <div class="col-sm-12 profile-form">
                                                                        ...
                                                                        <?php echo form_open('site/profile', array('role' => 'form bv-form', 'class' => 'form-horizontal', 'autocomplete' => 'off', 'method' => 'POST', 'id' => '', 'data-bv-feedbackicons-valid' => 'glyphicon glyphicon-ok', 'data-bv-feedbackicons-invalid' => "glyphicon glyphicon-remove", 'data-bv-feedbackicons-validating' => "glyphicon glyphicon-refresh")); ?>
                                                            ...
                                                            <div id="lang_tab" class="tab-pane login fade <?php echo ($this->session->get('tablang')) ? 'in active' : ''; ?>">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            <span>
                                                                        ...
                                                                        <?php echo form_open('site/profile', array('role' => 'form bv-form', 'class' => 'form-horizontal', 'autocomplete' => 'off', 'method' => 'POST')); ?>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="text-center">
                                                                            <div class="col-sm-12 col-xs-12">
                                                                                <button type="submit" name="language_submit" value="test"   class="btn btn-sm btn-continue"><?php echo lang('app.language_admin_submit'); ?></button>
                                                                                <img alt="loading" class="loading" style="display:none;" src="<?php echo base_url('public/images/loading.gif'); ?>">
                                                                            </div>
                                                                        </div>
                                                                        <?php echo form_close(); ?>
