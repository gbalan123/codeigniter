...
<div class="panel panel-default">
    <div class="panel-body">
        <b><?php echo lang('app.language_dashboard_practice_test_title_a'); ?></b>
        <div class="row mt20">
...
<div class="panel panel-default">
    <div class="panel-body">
        <b><?php echo lang('app.language_dashboard_practice_test_title_b'); ?></b>
        <div class="row mt20">
                        ...
                        <tbody>
                            ...
                            <?php 
                                if($this->lang->lang() == 'ms'):
                                    $skill_sets = array('Listening', 'Reading', 'Writing', 'Speaking');
                                    $skill_sets_ms = array(lang('language_dashboard_practice_test_listening'), lang('language_dashboard_practice_test_reading'), lang('language_dashboard_practice_test_writing'), lang('language_dashboard_practice_test_speaking'));
