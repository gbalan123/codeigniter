						...
						<div class="tab-content">
							...
							<div class="row">
									...
									?>	
									 <?php if ($organization_data['type_of_token'] == 'benchmarktest'): ?>
										<?php if($launchTestService == 0){?>
											...
											<span class="pull-right"><a class="help_icon_hide" href="<?php if($this->lang->lang() == 'en'){ echo $helplinks['3']['target_url'];} elseif($this->lang->lang() == 'ms'){ echo $helplinks['11']['target_url'];}  ?>"  target="_blank"  title="help"><img src="<?php echo base_url() . 'public/images/ico-help.png'; ?>" alt="icon" /></a></span>
									...
									<?php elseif (isset($test_type) && $test_type == 'benchmarking'): ?>
					                    ...
					                    <span class="pull-right"><a class="help_icon_hide" href="<?php if($this->lang->lang() == 'en'){ echo site_url();} elseif($this->lang->lang() == 'ms'){ echo $helplinks['11']['target_url'];}  ?>"  target="_blank"  title="help"><img src="<?php echo base_url() . 'public/images/ico-help.png'; ?>" alt="icon" /></a></span>
										<div class="clearfix"></div>
					                    </h4>
					                ...
					                <?php else: ?>
					                    ...
					                    <span class="pull-right"><a class="help_icon_hide" href="<?php if($this->lang->lang() == 'en'){ echo'en';} elseif($this->lang->lang() == 'ms'){ echo $helplinks['11']['target_url'];}  ?>"  target="_blank"  title="help"><img src="<?php echo base_url() . 'public/images/ico-help.png'; ?>" alt="icon" /></a></span>
										<div class="clearfix"></div>
					                    </h4>
