    ...
    <tr>
        <td width="50%">
            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:20px;">
                <tr>
                    <td>
                        <img src="<?php echo base_url('public/images/cats_logo_pdf.png'); ?>" style="width: 210px;" alt="Cats Logo Pdf"/>
                    </td>
                </tr>
            </table>
            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:20px;">
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:20px;">
    <tr>
        <td align="center" style="<?php echo $overall_level == "A0" ? "visibility:visible" : "visibility:hidden"; ?>"><img src="<?php echo base_url('public/images/higher_certificate/A0.png'); ?>" alt="Loading"/></td>
        <td align="center" style="<?php echo $overall_level == "A1" ? "visibility:visible" : "visibility:hidden"; ?>"><img src="<?php echo base_url('public/images/higher_certificate/A1.png');  ?>" alt="Loading"/></td>
        <td align="center" style="<?php echo $overall_level == "A2" ? "visibility:visible" : "visibility:hidden"; ?>"><img src="<?php echo base_url('public/images/higher_certificate/A2.png');  ?>" alt="Loading"/></td>
        <td align="center" style="<?php echo $overall_level == "B1" ? "visibility:visible" : "visibility:hidden"; ?>"><img src="<?php echo base_url('public/images/higher_certificate/B1.png');  ?>" alt="Loading"/></td>
        <td align="center" style="<?php echo $overall_level == "B2" ? "visibility:visible" : "visibility:hidden"; ?>"><img src="<?php echo base_url('public/images/higher_certificate/B2.png');  ?>" alt="Loading"/></td>
        <td align="center" style="<?php echo $overall_level == "C1" ? "visibility:visible" : "visibility:hidden"; ?>"><img src="<?php echo base_url('public/images/higher_certificate/C1.png');  ?>" alt="Loading"/></td>
        <td align="center" style="<?php echo $overall_level == "C2" ? "visibility:visible" : "visibility:hidden"; ?>"><img src="<?php echo base_url('public/images/higher_certificate/C2.png');  ?>" alt="Loading"/></td>
    </tr>
    <tr>
