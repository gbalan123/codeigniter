    ...
    <div class="box-border">
        ...
        <div class="section-border mb20">
            <div class="row chart-body mb20 statement-performance">
                ...
                echo ($results['cefr_level'] == $long_name)? "long": "";?> <?php echo ($results['display_popup'] == "popup" && $results['cefr_level'] != $long_name)? "popup_unstyled": "";?>">
                    <li><span>Overall Performance</span></li>
                    <li><span <?php if($results['result_status'] != "Pass"){ echo "class=achived" ;} ?>>Result</span> <div <?php echo ($results['result_status'] != "Pass" && $results['display_popup'] == "popup")? ($results['cefr_level'] != $long_name?"class=inner-values_not_achived" : "class=inner-values_not_achived_long"):"class=inner-values";?>><?php echo $results['result_status'];?></div></li>
                    ...
                    <li><span <?php if($results['result_status'] != "Pass"){ echo "class=achived" ;} ?>>CEFR Level :</span> <div <?php echo ($results['display_popup'] == "popup" && $results['cefr_level'] == $long_name)? "class=inner-values_long":"class=inner-values";?>><?php echo $results['cefr_level'];?></div></li>
                </ul>
                <?php if($results['cefr_level_content'] != ""){ ?>
                <ul class="list-styled <?php echo ($results['display_popup'] == "popup")? "popup_styled": "";?>">
        ...
        <div class="section-border mb20 statement-performance">
            ...
            <span style="font-size: 14px;"><i>Performance in Listening and Reading counts towards the overall result.</i></span>
        ...
        <div class="section-border mb20">
            <div class="row">
                <div class="col-md-4 first_gird col-sm-12">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "first_gird_size":"first_non_popup";?> <?php echo get_grid_class_view($p, 'A1.1', $results['display_popup']); ?>">
                ...
                <div class="col-md-4 first_gird col-sm-12">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "first_gird_size":"first_non_popup";?> <?php echo get_grid_class_view($p, 'A1.2', $results['display_popup']); ?>">
                ...
                <div class="col-md-4 first_gird col-sm-12">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "first_gird_size":"first_non_popup";?> <?php echo get_grid_class_view($p, 'A1.3', $results['display_popup']); ?>">
                ...
                <div class="col-md-4 second_gird col-sm-12">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "second_gird_size":"second_non_popup";?> <?php echo get_grid_class_view($p, 'A2.1', $results['display_popup']); ?>">
                ...
                <div class="col-md-4 second_gird col-sm-12 inner_mobile_gird">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "second_gird_size":"second_non_popup";?> <?php echo get_grid_class_view($p, 'A2.2', $results['display_popup']); ?>">
                ...
                <div class="col-md-4 second_gird col-sm-12 inner_mobile_gird">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "second_gird_size":"second_non_popup";?> <?php echo get_grid_class_view($p, 'A2.3', $results['display_popup']); ?>">
                ...
                <div class="col-md-4 third_grid col-sm-12">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "third_grid_size":"third_non_popup";?> <?php echo get_grid_class_view($p, 'B1.1', $results['display_popup']);?>">
                ...
                <div class="col-md-4 third_grid col-sm-12">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "third_grid_size":"third_non_popup";?> <?php echo get_grid_class_view($p, 'B1.2', $results['display_popup']);?>">
                ...
                <div class="col-md-4 third_grid col-sm-12">
                    <div class="<?php echo ($results['display_popup'] == "popup")? "third_grid_size":"third_non_popup";?> <?php echo get_grid_class_view($p, 'B1.3', $results['display_popup']);?>">
...
<?php 
    function get_grid_class_view($current_position, $level, $display_type){
