                        ...
                        <div class="tab-content">
                            <div id="get_started_tab" class="tab-pane get_start fade in active">
                                <div class="row">
                                    ...
                                    <?php if( Null !== session()->get("primaryerrors") || $validation->getError('user_name') != NULL || $validation->getError('user_password') ): 

                                             ?>
                                                <div class="alert alert-danger fade in">
                                                    <a href="#" class="close" data-dismiss="alert">&times;</a>
                                                    <?php
                                                    if ($validation->getError('user_name')) {
                                                         echo "<p>".$validation->getError('user_name')."</p>";
                                                    }
                                                    if ($validation->getError('user_password')) {
                                                        echo "<p>".$validation->getError('user_password')."</p>";
                                                    }
                                                    ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="user_name"  name="user_name" value="<?php echo set_value('user_name'); ?>"  class="form-control input-sm"  />												
                                                    </div>											
                                                </div>	
                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label><?php echo lang('app.language_site_booking_screen_m1_password_label'); ?></label>
                                                        <input type="password" id="user_password" name="user_password" value="<?php echo set_value('user_password'); ?>"  class="form-control input-sm"  />
                                                    </div>
                                                </div>
