...
$firstnameDatas 		= "firstname";
$secondnameDatas 		= "secondname";
$emailDatas 			= "email";
$confirm_emailDatas		= "confirm_email";
$passDatas				= "password";
$confirm_passDatas		= "confirm_password";
$termsDatas				= "terms";
$usernameDatas			= "username";
?>
														...
														<div class="panel-heading">
															<ul class="nav nav-tabs">																 
																...
																<span class="help_icon">
																	<a class="help_icon_hide" id="signup_help" href="<?php if($this->lang->lang() == 'en'){ echo $helplinks['1'][$target_urlDatas];} elseif($this->lang->lang() == 'ms'){ echo $helplinks['9'][$target_urlDatas];}  ?>" target="_blank"  title="help"><img  src="<?php echo base_url() . '/public/images/ico-help.png'; ?>" alt="icon" /></a>
																	<a class="help_icon_hide" id="login_help" style="display:none;" href="<?php if($this->lang->lang() == 'en'){ echo $helplinks['2'][$target_urlDatas];} elseif($this->lang->lang() == 'ms'){ echo $helplinks['10'][$target_urlDatas];}  ?>" target="_blank"  title="help"><img  src="<?php echo base_url() . '/public/images/ico-help.png'; ?>" alt="icon" /></a>
																</span></li>
																...
																<div id="signup_tab" role="tabpanel" class="tab-pane signup fade <?php echo ($this->session->get('tabsignup')) ? 'active in' : ''; ?>" >
																	...
																	<div class="row">
																		<div class="col-md-6 col-sm-12 col-xs-12">
																			<div class="form-group">
																				<input type="text" class="form-control input-sm" id="reg_firstname" name="firstname"  value="<?php echo set_value($firstnameDatas); ?>" placeholder=" <?php echo lang('app.language_site_booking_screen2_label_first_name'); ?> *" required />
                                        									
                                                                                <?php if ($this->validation->getError($firstnameDatas)) : ?>
	                                                                                <P>
                                                                                      <?= $this->validation->getError($firstnameDatas) ?>
                                                                                </P>
	                                                                            <?php endif; ?> 
																			</div>
																		</div>
																		<div class="col-md-6 col-sm-12 col-xs-12">
																			<div class="form-group">
																				...
																				<input type="text" class="form-control input-sm" id="reg_secondname" name="secondname" value="<?php echo set_value($secondnameDatas); ?>"
									                                               placeholder=" <?php echo lang('app.language_site_booking_screen2_label_second_name'); ?> *" required />
									                                           
                                                                                 <?php if ($this->validation->getError($secondnameDatas)) : ?>
	                                                                                <P>
                                                                                      <?= $this->validation->getError($secondnameDatas) ?>
                                                                                      </P>
	                                                                            <?php endif; ?> 
																			</div>
																		...
																		<div class="col-md-6 col-sm-12 col-xs-12">
																			<div class="form-group">
																				...
																				<input type="email" id="reg_email" class="form-control input-sm" name="email" value="<?php echo set_value($emailDatas); ?>"
								                                               placeholder="<?php echo lang('app.language_site_booking_screen2_label_email_address'); ?> *" required />
								                                           
                                                                               <?php if ($this->validation->getError($emailDatas)) : ?>
	                                                                                <P>
                                                                                      <?= $this->validation->getError($emailDatas) ?>
                                                                                      </P>
	                                                                            <?php endif; ?> 
																			</div>
																		</div>
																		<div class="col-md-6 col-sm-12 col-xs-12">
																			<div class="form-group">
																				<input type="email" id="reg_confirm_email" class="form-control input-sm" name="confirm_email" value="<?php echo set_value($confirm_emailDatas); ?>"
								                                               placeholder="<?php echo lang('app.language_site_booking_screen2_label_confirm_email_address'); ?> *" required />
								                                             
                                                                               <?php if ($this->validation->getError($confirm_emailDatas)) : ?>
	                                                                                <P>
                                                                                      <?= $this->validation->getError($confirm_emailDatas) ?>
                                                                                      </P>
	                                                                            <?php endif; ?>
																			</div>
																		</div><div class="clearfix"></div>
																		<div class="col-md-6 col-sm-12 col-xs-12">
																			<div class="form-group">
																				<input type="password" id="reg_password" name="password" value="<?php echo set_value($passDatas); ?>" class="form-control input-sm" placeholder="<?php echo lang('app.language_site_booking_screen2_label_password'); ?> *" required title="" />

										                                     
                                                                                 <?php if ($this->validation->getError($passDatas)) : ?>
	                                                                                <P>
                                                                                      <?= $this->validation->getError($passDatas) ?>
                                                                                 </P>
	                                                                            <?php endif; ?>
																			</div>
																		</div>
																		<div class="col-md-6 col-sm-12 col-xs-12">
																			<div class="form-group">
																				<input type="password" id="reg_confirm_password" value="<?php echo set_value($confirm_passDatas); ?>" class="form-control input-sm" name="confirm_password"
								                                               placeholder="<?php echo lang('app.language_site_booking_screen2_label_confirm_password'); ?> *" required />
                                                                               <?php if ($this->validation->getError($confirm_passDatas)) : ?>
	                                                                                <P>
                                                                                      <?= $this->validation->getError($confirm_passDatas) ?>
                                                                               </P>
	                                                                            <?php endif; ?>
																			</div>
																		</div><div class="clearfix"></div>
                                                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                                                            <div class="form-group">
                                                                                <div class="input_checkbox">
                                                                                    <span>
                                                                                    <?php $id = 'id="terms_signup" class="checkbox-inline"'; ?><?php echo form_checkbox($termsDatas, '1', set_checkbox($termsDatas, '1'), $id); ?></span>
                                                                                ...
                                                                                <?php if ($this->validation->getError($termsDatas)) : ?>
	                                                                                <P>
                                                                                      <?= $this->validation->getError($termsDatas) ?>
                                                                                </P>
	                                                                            <?php endif; ?>
                                                                            </div>
                                                                        </div>
																		...
																		<div class="col-md-6 col-sm-12 col-xs-12">
																			<div class="form-group">
																				<input type="text"  id="log_email" class="form-control input-sm" name="username"
										                                               placeholder=" <?php echo lang('app.language_site_booking_screen2_label_email_address'); ?> *" value="<?php echo set_value($usernameDatas); ?>" />
										                
                                                                                <?php if ($this->validation->getError($usernameDatas)) : ?>
	                                                                                <P>
                                                                                      <?= $this->validation->getError($usernameDatas) ?>
                                                                                </P>
	                                                                            <?php endif; ?> 
																			</div>
																		</div>
