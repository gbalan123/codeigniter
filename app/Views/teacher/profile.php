...
<div class="bg-lightgrey">
    <div class="container">
        <div class="get_started col-sm-12" style="margin-bottom:40px;">
			<div class="main_tab">
				 <p class="pull-left p20"><a href="<?php echo site_url('teacher/dashboard'); ?>"><span class="fa fa-long-arrow-left"></span> <?php echo lang('app.language_search_events_back_to_dash'); ?></a></p>
			</div>
			<div class="main_tab_content clear">
							...
							<div class="tab-content">
								...
								<div class="row">
									<div class="col-sm-12 profile-form">
										<?php echo form_open('teacher/profile', array('role' => 'form bv-form', 'class' => 'form-horizontal', 'autocomplete' => 'off', 'method' => 'POST', 'id' => '', 'data-bv-feedbackicons-valid' => 'glyphicon glyphicon-ok', 'data-bv-feedbackicons-invalid' => "glyphicon glyphicon-remove", 'data-bv-feedbackicons-validating' => "glyphicon glyphicon-refresh")); ?>
