...
<div class="institution_content">
                            ...
                            <table  class="table table-bordered institution_table">
                              ...
                              <div class="row">
                                ...
                                <button type="button" <?php echo ($count == $total_searchData ) ? 'disabled' : '';?>  class="btn btn-sm btn-continue"  id="addLearnerBtn"><?php echo lang('app.language_teacher_classes_add_btn'); ?></button> <img class="loading_main" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
                            <?php else: ?>
                                ...
                                <div class="table-responsive view-tokens mt30">
                                    <table class="table table-bordered institution_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php if (!empty($class_learners) && count($class_learners) > 1) {  
                                                    ...
                                                    <?php echo anchor(current_url() ."?".$without_email['0']. "&name=" . (($this->request->getVar('name') == 'ASC') ? 'DESC' : 'ASC'), lang('app.language_teacher_toknpage_email_username') . (($this->request->getVar('name') == 'ASC') ? '&nbsp;<i class="fa fa-arrow-up" aria-hidden="true"></i>' : '&nbsp;<i class="fa fa-arrow-down" aria-hidden="true"></i>'), array('style' => 'color:white;')); ?>
                                                <?php } else { ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="center">
                                                <?php //if(empty($class_learner->section_one)) {
                                            ?>
                                            <!-- create id="studentClassId1" -->
                                                ...
                                                <?php  //if(!empty($class_learner->token)) { ?>
                                                ...
                                                <td>
                                                    ...
                                                    //Core user download pdf link in qrverify view
                                                /* if(strlen($class_learner['cats_product']) === 0){
                                                        $qrverify = 'teacher/qrverify_u13';                                                    
                                                    }else{
                                                        $qrverify = 'teacher/qrverify_u13';
                                                    }*/
                                                    if (isset($class_learner['final_test']) && ($class_learner['final_test']['final_result_status'] == 1)) {
                           ...
                           <?php else: ?>
                             <div class="text-right mt30">
                                ...
                                <button type="button" class="btn btn-sm btn-continue"  data-toggle="modal"  data-backdrop="static" data-keyboard="false"  data-target="#addupdateModal" id="addBtn"><i class="fa fa-plus fa-fw"></i><?php echo lang('app.language_teacher_classes_add_btn'); ?></button>
                                <button type="button" <?php echo (empty($classesData['classes'])) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  data-toggle="modal" data-backdrop="static" data-keyboard="false"  data-target="#updateaddModal" id="editBtn"><i class="fa fa-edit fa-fw"></i><?php echo lang('app.language_teacher_classes_viewedit_btn'); ?></button>
                                <button type="button" <?php echo (empty($classesData['classes'])) ? 'disabled' : '' ?> class="btn btn-sm btn-continue"  id="deleteBtn"><i class="fa fa-trash-o fa-fw"></i><?php echo lang('app.language_teacher_classes_delete_btn'); ?></button>
                            </div>
							<div class="institution_content">
                            ...
                            // echo '<pre>'; print_r($classesData); echo '</pre>';  exit;

                                                // $CI = & get_instance(); // Student count for a class - WP-1177
                ...
                <div class="modal-header" style="border-bottom: 0px solid #e5e5e5;">
                    ...
                    <h4 class="modal-title"
                        style="font-weight: bold; text-align: center;">
                            ...
                            <?php //echo lang('app.language_distributor_add_venue');   ?>&nbsp;<img class="loading_main" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
                </h4>
                </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content" >
                <div class="modal-header" style="border-bottom: 0px solid #e5e5e5;">
                    <button type="button" class="close" data-dismiss="modal"
                            aria-hidden="true">&times;</button>
                    <h4 class="modal-title" style="font-weight: bold; text-align: center;">&nbsp;<img class="loading_main" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" /></h4>
                </div>
                <div class="modal-body" >
...
<div id="history_modal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img class="loading_history text-center" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
      </div>
