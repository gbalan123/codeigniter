...
<div class="bg-white">
    <div class="container-fluid nopadding">
        <div class="navbar-header">
            <div class="logo"> 
                <a href="<?php echo ($this->acl_auth->logged_in()) ? site_url('teacher/dashboard') : site_url(); ?>" class="navbar-brand"><img src="<?php echo base_url() . '/public/images/logo_new.svg'; ?>" class="img-responsive" alt="CATs Logo" /></a> 
            </div>
        </div>
        <div class="langeage-box">
            ...
            <?php if ($this->acl_auth->logged_in()) { 		
                ...
                <div class="dropdown user_logout" id="userDropdown">
                    <a class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <em class="fa fa-user fa-2x"></em> <?php echo $striped_user; ?>
                    </a>
                    <div class="dropdown-menu  dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="<?php echo site_url('teacher/dashboard'); ?>"><span class="fa fa-dashboard " style="color: #fff;"></span>&nbsp;<?php echo lang('app.language_dashboard'); ?></a>
                        <a class="dropdown-item" href="<?php echo site_url('teacher/profile'); ?>"><span class="fa fa-user " style="color: #fff;"></span>&nbsp;<?php echo lang('app.site_label_drop_profile'); ?></a>
