    ...
    <div class="col-xs-12">
        <div class="panel panel-default">   
            <div class="panel-heading">
                <em class="fa fa-plus fa-fw"></em><?php echo $class_heading; ?>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 clearfix">
                        ...
                        <div class="form-group form-actions pull-right" style="clear:both;">
                            <button type="submit" id="submitBtn" class="btn btn-lg btn-primary wpsc_button" ><?php echo lang('app.language_admin_institutions_submit_btn'); ?></button><img alt="loading" id="loading_in" style="display: none;" src="<?php echo base_url('public/images/loading.gif'); ?>" />
                        </div>	 
                        <?php form_close(); ?>
                    </div>
