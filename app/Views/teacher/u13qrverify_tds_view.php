<?php //print '<pre>'; print_r($results); print '</pre>';?>
<!DOCTYPE html>
<html lang="en">
        	...
        	<div class="content_area">
	            <div> 
            	    ...
            	    <div class="left_content">
                    	<div class="logo">
	                        <img src="<?php echo base_url('public/images/logo_new.svg'); ?>">
                    	</div>
                    	...
                    	<div class="exam_details">
            				...
            				?>
	                    	<p>Date of Exam: <span><?php echo $date_of_exam; //echo  date('d F Y', strtotime('-1 day', strtotime($results['userDetails']['result_date'])));  //date("d F Y",strtotime($results['userDetails']['purchased_date'])); ?></span></p>
