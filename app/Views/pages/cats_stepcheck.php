...
<div class="checkstep_home_page">
    <div class="container-fluid">
        <div class="home_banner about_course_test info_educat">
            <div class="row">
                <img src="<?php echo base_url('public/images/cats-stepcheck-home.jpg'); ?>">
                                    ...
                                    <div class="checkstep_subcard tranquil">
                                        ...
                                        <div class="subcard_content">
                                            ...
                                            <div class="separator_icon">
                                                <img src="<?php echo base_url('public/images/icon-content-splitter.png'); ?>">
                                                <hr class="separator">
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="checkstep_box_one box_content">                            
                                        ...
                                        <div class="box_img">
                                            <img src="<?php echo base_url('public/images/who_stepcheck_1.jpg'); ?>">
                                        </div>
                                        <div class="box_content text-center">
                                            <p><?php echo lang('app.language_site_main_stepcheck_recurit'); ?></p>
                                            <a href="<?php echo site_url("/pages/cats_stepcheck_employers"); ?>" class="btn btn-sm btn-continue btn-pink"><?php echo lang('app.language_site_main_stepcheck_learn_more'); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="checkstep_box_one two box_content">                            
                                        ...
                                        <div class="box_img">
                                            <img src="<?php echo base_url('public/images/who_stepcheck_2.jpg'); ?>">
                                        </div>
                                        <div class="box_content text-center">
                                            <p><?php echo lang('app.language_site_main_stepcheck_institutions_for'); ?></p>
                                            <a href="<?php echo site_url("/pages/cats_stepcheck_education"); ?>" class="btn btn-sm btn-continue btn-pink"><?php echo lang('app.language_site_main_stepcheck_learn_more'); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="checkstep_box_one three box_content">                            
                                        ...
                                        <div class="box_img">
                                            <img src="<?php echo base_url('public/images/who_stepcheck_3.jpg'); ?>">
                                        </div>
                                        <div class="box_content text-center">
                                            <p><?php echo lang('app.language_site_main_stepcheck_goverment_targets'); ?></p>
                                            <a href="<?php echo site_url("/pages/cats_stepcheck_goverment"); ?>" class="btn btn-sm btn-continue btn-pink"><?php echo lang('app.language_site_main_stepcheck_learn_more'); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="checkstep_about">
                                        <div class="checkstep_about_img">
                                            <img src="<?php echo base_url('public/images/checkstep-about.jpg'); ?>">
                                        </div>
                        ...
                        <div class="cats_checkstep_skill">
                            ...
                            <div class="stepcheck_express">
                                <ul class="list-unstyled stepcheck_express_list tranquil">
                                    <li>
                                        <div class="skill_title text_center">
                                            <h3><?php echo lang('app.language_site_main_stepcheck_stepcheck'); ?><span class="disp_block"><?php echo lang('app.language_site_main_stepcheck_express'); ?></span> </h3>
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <ul class="list-unstyled stepcheck_express_list tranquil alabaster mt40">
                                    <li>
                                        <div class="skill_title text_center">
                                            <h3><?php echo lang('app.language_site_main_stepcheck_stepcheck'); ?><span class="disp_block"><?php echo lang('app.language_site_main_stepcheck_ex_with_speaking'); ?></span> </h3>
                                        </div>
                                    </li>
                                    <li>
                                        <ul class="skill_sublist_head">
                                ...
                                <ul class="list-unstyled stepcheck_express_list tranquil solitude mt40">
                                    <li>
                                        <div class="skill_title text_center">
                                            <h3><?php echo lang('app.language_site_main_stepcheck_stepcheck'); ?><span class="disp_block"><?php echo lang('app.language_site_main_stepcheck_ex_communicator'); ?></span> </h3>
                                        </div>
                                    </li>
                                    <li>
                                        <ul class="skill_sublist_head">
                        ...
                        <div class="cats_checkstep_support">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="checkstep_about">
                                        <div class="checkstep_about_img">
                                            <img src="<?php echo base_url('public/images/cats-checkstep-support.jpg'); ?>">
                                        </div>
                                        <div class="checkstep_about_content">
