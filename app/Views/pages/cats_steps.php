...
<?php
    ...
    $cats_listImage = base_url('public/images/cats-list.png');
?>
<div class="course_steps">
    <div class="container-fluid">
        <div class="home_banner about_course_test">
            <div class="row">
                <img src="<?php echo base_url('public/images/about-course-banner.jpg'); ?>" alt="about-course-banner">
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="cats_course_list">
                                <ul class="list-unstyled">
                                    <li><a class="scroll_to" href="#primary"><img src="<?= $cats_listImage; ?>" alt="cats-list"/><span><?php echo lang('app.cats_steps_primary'); ?></span></a></li>
                                    <li><a class="scroll_to" href="#core"><img src="<?= $cats_listImage; ?>" alt="cats-list"/><span><?php echo lang('app.cats_steps_core'); ?></span></a></li>
                                    <li><a class="scroll_to" href="#higher"><img src="<?= $cats_listImage; ?>" alt="cats-list"/><span><?php echo lang('app.cats_steps_higher'); ?></span></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-12 col-xs-12 text_center">
                            <p><?php echo lang('app.cats_steps_consisted'); ?></p>
                            <span class="educat_flowchart"><img src="<?php echo base_url('public/images/cats-ref-flowchart.png'); ?>" alt="cats-ref-flowchart"></span>
                                        ...
                                        <div class="cats_primary_block">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12 text-center">
                                                    <span class="primary_img"><img src="<?php echo base_url('public/images/cats-primary.png'); ?>" alt="cats-primary"/></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 text-center">
                                        <div class="cats_primary_user_content">
                                            <div class="cats_primary_user">
                                                <img src="<?php echo base_url('public/images/cats-primary-img.png'); ?>" alt="cats-primary-img"/>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-12 col-xs-12">
                                        <div class="cats_primary_block cats_core_block">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12 text-center">
                                                    <span class="primary_img"><img src="<?php echo base_url('public/images/cats-core.png'); ?>" alt="cats-core"/></span>
                                                </div>
                                            </div>
                                            <form class="form-horizontal">
                                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 text-center">
                                        <div class="cats_primary_user_content">
                                            <div class="cats_primary_user">
                                                <img src="<?php echo base_url('public/images/cats-core-img.png'); ?>" alt="cats-core-img"/>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-12 col-xs-12">
                                    <div class="cats_primary_block cats_higher_block">
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12 text-center">
                                                <span class="primary_img"><img src="<?php echo base_url('public/images/cats-higher.png'); ?>" alt="cats-higher"/></span>
                                            </div>
                                        </div>
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 text-center">
                                    <div class="cats_primary_user_content">
                                        <div class="cats_primary_user">
                                            <img src="<?php echo base_url('public/images/cats-higher-img.png'); ?>" alt="cats-higher-img"/>
                                        </div>
