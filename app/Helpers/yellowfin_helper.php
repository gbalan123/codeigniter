...
function yellowfin($userId){
    ...
    if($userId != ""){
         ...
         if($query->getNumRows() > 0){
            ...
            // $webserviceAdminPassword = 'cpt@dmin';
            ...
            $AdministrationServiceRequest['loginId'] = $webserviceAdmin; //$GLOBALS['webserviceAdmin'];
            $AdministrationServiceRequest['password'] = $webserviceAdminPassword; //$GLOBALS['webserviceAdminPassword'];
