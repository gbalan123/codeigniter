...
namespace App\Models\Teacher;//path
...
class Teachermodel extends Model
{
    ...
    //teachers class with active learners
    ...
    function get_teacher_classes($institutionTeacherId = FALSE) {
        ...
        if ($institutionTeacherId != FALSE):
            ...
            //$builder->join('student_classes', 'student_classes.teacherClassId = teacher_classes.teacherClassId');
    ...
    //get student classes by teacher Class id
