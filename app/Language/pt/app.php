...
"language_admin_institutions_add_sentences" => "To add a learner to a group, enter the learner’s name or full email address in the search box and search for the learner. From the search results, select the learner and click the Add button to add the learner to the group.",
...
"language_admin_cms_getstarted" => "Iniciar",
"language_admin_cms_findoutmore" => "Find out more..",
"language_admin_cms_startenglishtoday" => "É fácil começar a aprender inglês hoje!",
"language_admin_cms_home_section1_title" => "Inglês do mundo real",
"language_admin_cms_home_section1_content" => "Nossos cursos oferecem vocabulários reais de inglês que você poderá utilizar para ajudá-lo em seu trabalho e em sua vida cotidiana.",
"language_admin_cms_home_section2_title" => "Aprendizagem flexível",
"language_admin_cms_home_section2_content" => "CATs tem extensa gama de materiais para preparação e prática de inglês. Estes materiais foram formatados para cursos de Preparação e de Prática.",
"language_admin_cms_home_section2_content1" => "Aprenda online no horário que se adequar a você e ao seu ritmo. Nossos cursos flexíveis permitem que você estude em qualquer lugar e oferecemos todas as ferramentas necessárias para você ter sucesso.",
"language_admin_cms_home_section3_title" => "Realizável",
"language_admin_cms_home_section3_content" => "Nós tornamos o aprendizado de inglês fácil. Adequado desde o nível para iniciantes. Nós ajudaremos você a progredir de verdade!",
"language_admin_cms_home_section4_title" => "Reconhecimento",
"language_admin_cms_home_section4_content" => "Recompensamos o seu esforço com qualificações de referência internacional que irão ajudá-lo a progredir.",
"language_admin_cms_home_footer_section_findoutmore" => "Saiba mais..",
"language_admin_cms_goverment_section1_title" => "Governantes e Ministérios de Educação",
"language_admin_cms_goverment_section1_content" => "À medida que as competências em inglês de uma população melhoram, o desempenho econômico de um país também aumenta. O Programa CATs é uma forma acessível de melhorar as habilidades de inglês de uma nação. O Programa pode fornecer cursos de inglês para um grande número de alunos em lugares diferentes. Todos os exames atendem aos padrões internacionais de aprendizado de exames de idiomas. As pessoas podem melhorar suas possibilidades de emprego e aumentar seus potenciais desenvolvendo habilidades em inglês. O Programa CATs foi desenvolvido para complementar os programas de idiomas existentes em escolas, para ajudar adultos a aprenderem inglês no local de trabalho e para auxiliar aos pais a apoiarem o aprendizado de idiomas de seus filhos. A flexibilidade do programa permite que os alunos realizem os passos adequados para alcançar seus objetivos de aprendizagem. O inglês é uma competência fundamental para negócios internacionais. A flexibilidade e a viabilidade do Programa CATs ajudam os empregadores a desenvolverem a capacidade de inglês em sua força trabalhista. Isso ajuda as organizações a aproveitar as novas oportunidades de negócios e a se tornarem mais competitivas na economia global.",
"language_admin_cms_goverment_section2_title" => "Why CATs?",
"language_admin_cms_goverment_section2_content" => "O Programa CATs é um novo e potente sistema online de aprendizagem e certificação de inglês, desenvolvido pelo Cambridge Malaysian Education and Development Trust (CMEDT).",
"language_admin_cms_goverment_section2_content1" => "O Programa CATs é projetado para complementar o aprendizado da língua inglesa em escolas primárias e secundárias, para apoiar jovens adultos no ensino superior e ajudar aqueles que precisam melhorar seu inglês para o trabalho. Também ajudará os pais a auxiliarem seus filhos a aprender inglês. O Programa CATs inclui uma série de avaliações lineares, um sistema de exame adaptativo e material de preparação e prática.",
"language_admin_cms_goverment_section3_title" => "A Diferença do Programa CATs",
"language_admin_cms_goverment_section3_content" => "A fim de maximizar o potencial dos alunos, o Programa CATs divide os níveis tradicionais de avaliação do idioma em subníveis menores, que podem ser alcançados mais facilmente. Os alunos estudam em seu próprio ritmo, apoiados por várias centenas de horas de recursos on-line. Essa abordagem torna o aprendizado da língua inglesa accessível a todos, independentemente de seus níveis de escolaridade ou experiência prévia em aprendizado de idiomas.",
"language_admin_cms_goverment_section4_title" => "Padrões Internacionais",
"language_admin_cms_goverment_section4_content" => "O sistema de CATs é chancelado aos níveis do Quadro Europeu Comum de Referência (CEFR) - o padrão internacional amplamente reconhecido para a aprendizagem de línguas.",
...
"language_admin_cms_about_title" => "Sobre Quem Somos",
"language_admin_cms_about_content" => "O Programa CATs foi desenvolvido em Cambridge, uma cidade reconhecida pela inovação em tecnologia, ciência e educação. Criado por uma equipe de especialistas de reconhecimento mundial em ensino e avaliação de inglês, todos com registros comprovados de desenvolvimento de materiais de alta qualidade para organizações educacionais líderes mundiais.",
"language_admin_cms_about_content1" => "Todos os materiais são chancelados de acordo com o Quadro Europeu Comum de Referência (CEFR) e têm qualidade assegurada segundo os padrões internacionais.",
...
"language_admin_cms_features_section1_title" => "Aprenda Inglês com o Programa CATs!",
"language_admin_cms_features_section1_content" => "Desenvolva competências em inglês que possam ser utilizadas no mundo de agora, no trabalho, em viagens e na vida!",
"language_admin_cms_features_section1_content1" => "O programa Core CATs de 9 níveis oferece uma abordagem arquitetada para melhorar suas competências em inglês em etapas pedagogicamente estruturadas.",
"language_admin_cms_features_section2_title" => "Aprendizagem e avaliação são conciliados para criar um programa completo de inglês.",
"language_admin_cms_features_section2_content" => "Os Exames do Programa CATs fornecem aos usuários o reconhecimento de suas conquistas na língua inglesa e os mantêm motivados a continuar aprendendo e desenvolvendo suas competências.",
"language_admin_cms_features_section2_content1" => "Os usuários recebem todos os materiais que precisam para aprendizagem e prática preparando-os para cada Exame CATs.",
"language_admin_cms_features_section2_content2" => "A abordagem de estudo individual e os materiais de prática flexíveis facilitam o aprendizado em horário e local que melhor convêm aos usuários.",
"language_admin_cms_features_section3_title" => "Usuários podem estudar quando quiserem utilizando o aplicativo móvel de aprendizagem.",
"language_admin_cms_features_section3_content" => "Faça aulas com o Programa CATs utilizando seu smartphone ou tablet em horários e locais oportunos.",
"language_admin_cms_features_section3_content1" => "The dynamic digital English lessons have been carefully created with a wide variety of interactive activities, audio and video material to ensure the lessons are clear, interesting and lots of fun.",
"language_admin_cms_features_section4_title" => "Tudo o que os usuários precisam para desenvolver com sucesso suas competências em inglês",
"language_admin_cms_features_section4_content" => "Quando os usuários estiverem prontos a prestarem um exame de nível de 45 a 60 minutos, eles serão guiados através de um processo simples para reservar uma sessão em um dos Centros de Exame, na escola ou até mesmo em casa.",
"language_admin_cms_features_section4_content1" => "Após a conclusão, o usuário receberá informações sobre sua pontuação no exame e um feedback útil online.",
"language_admin_cms_features_section4_content2" => "Os Exames CATs têm qualidade garantida pelo Quadro Europeu Comum de Referência (CEFR) de idiomas. Isso dá aos usuários um reconhecido de conquista padronizado.",
"language_admin_cms_features_section5_content" => "Inscreva-se hoje e complete uma simples pré-avaliação on-line. Isso nos ajudará a posicioná-lo rapidamente em seu nível correto, para que você possa começar a aperfeiçoar seu inglês imediatamente.",
"language_admin_cms_features_footer_section_findoutmore" => "Conheça mais sobre as nove etapas do Programa CATs Core",
"language_admin_cms_courses_section1_title" => "O Programa CATs Core e seus Exames",
"language_admin_cms_courses_section1_content" => "O Programa CATs Core tem 3 etapas, sendo cada etapa composta por 3 cursos. O Programa completo CATs Core é, portanto, composto por 9 cursos no total.",
"language_admin_cms_courses_section1_content1" => "O progresso nestes nove níveis dará aos iniciantes todas as informações necessárias para se tornarem usuários da língua inglesa no nível intermediário.",
"language_admin_cms_courses_section2_title" => "O que está incluso em cada curso do Programa CATs?",
"language_admin_cms_courses_section2_content" => "Cada um dos 9 cursos do Programa CATs Core oferece aos alunos todos os materiais, apoio e orientação necessários para aprender, praticar e se prepararem para o Exame CATs no final do curso ...",
"language_admin_cms_courses_section2_course_txt_title" => "O Programa CATs de aprendizagem e prática",
"language_admin_cms_courses_section2_course_txt_title_online_prep" => "Preparação online",
"language_admin_cms_courses_section2_course_txt_content_online_prep" => "Cada curso on-line inclui cerca de 45 horas de material interativo de auto estudo, incluindo os Simuladores de Teste on-line.",
"language_admin_cms_courses_section2_course_txt_title_pract_test" => "Simuladores de Testes",
"language_admin_cms_courses_section2_course_txt_content_pract_test" => "Dois Simuladores de Testes on-line completos ajudarão os alunos a se prepararem para o Exame Final ao final de cada curso.",
"language_admin_cms_courses_section2_course_txt_title1" => "O Exame CATs",
"language_admin_cms_courses_section2_course_txt_content_cats_test" => "No final de cada curso, faça um exame em um dos Centro de Exames mais próximo, em uma escola ou até mesmo em casa. Os exames são online, levam de 45 a 60 minutos e os resultados estarão disponíveis logo após o término.",
"language_admin_cms_courses_section3_title" => "Sobre os nove níveis do Programa CATs Core",
"language_admin_cms_courses_section3_content" => "Existem 9 cursos no Programa CATs Core que levam os usuários desde nível iniciante ao intermediário. Quando os usuários se inscrevem pela primeira vez no Programa CATs, eles farão uma avaliação para descobrir o quanto de inglês já conhecem. Esta avaliação on-line garantirá que o aprendizado comece no nível exato.",
"language_admin_cms_courses_section3_cats_level_stage" => "Etapa",
"language_admin_cms_courses_section3_cats_level_youwillbe" => "Você poderá",
"language_admin_cms_courses_section3_cats_level_moreinfo" => "Mais Informações",
"language_admin_cms_courses_section3_cats_level_a1" => "A1",
"language_admin_cms_courses_section3_cats_level_a1_name" => "Step Forward",
"language_admin_cms_courses_section3_cats_level_a1_desc" => "Iniciante",
"language_admin_cms_courses_section3_cats_level_a1_abt1" => "Cumprimentar e se apresentar à outras pessoas.",
"language_admin_cms_courses_section3_cats_level_a1_abt2" => "Falar sobre você e sua família.",
"language_admin_cms_courses_section3_cats_level_a1_abt3" => "Perguntar por direções.",
"language_admin_cms_courses_section3_cats_level_a1_abt4" => "Escrever frases básicas sobre você, sua família e seu trabalho.",
"language_admin_cms_courses_section3_cats_level_a2" => "A2",
"language_admin_cms_courses_section3_cats_level_a2_name" => "Step Up",
"language_admin_cms_courses_section3_cats_level_a2_desc" => "Pré-Intermediário",
"language_admin_cms_courses_section3_cats_level_a2_abt1" => "Falar sobre pessoas e lugares comuns.",
"language_admin_cms_courses_section3_cats_level_a2_abt2" => "Falar sobre seus hobbies, gostos e frustrações.",
"language_admin_cms_courses_section3_cats_level_a2_abt3" => "Descrever e comparar coisas.",
"language_admin_cms_courses_section3_cats_level_a2_abt4" => "Falar sobre planos futuros e fazer planos para eventos sociais.",
"language_admin_cms_courses_section3_cats_level_a2_abt5" => "Expressar sua opinião.",
"language_admin_cms_courses_section3_cats_level_b1" => "B1",
"language_admin_cms_courses_section3_cats_level_b1_name" => "Step Ahead",
"language_admin_cms_courses_section3_cats_level_b1_desc" => "Intermediário",
"language_admin_cms_courses_section3_cats_level_b1_abt1" => "Falar sobre trabalho, hobbies, viagens e eventos.",
"language_admin_cms_courses_section3_cats_level_b1_abt2" => "Descrever pessoas e lugares.",
"language_admin_cms_courses_section3_cats_level_b1_abt3" => "Ler uma história ou um artigo.",
"language_admin_cms_courses_section3_cats_level_b1_abt4" => "Falar e escrever em inglês sem cometer muitos erros.",
"language_admin_cms_courses_section3_cats_level_b1_abt5" => "Escrever e-mails, histórias ou artigos simples.",
...
"language_admin_cms_courses_footer_section_title" => "É fácil começar a aprender Inglês hoje mesmo!",
"language_admin_cms_courses_footer_section_content" => "Assine o Programa CATs e comece a melhorar seu Inglês hoje mesmo!",
...
"language_jan" => "Janeiro",
"language_feb" => "Fevereiro",
"language_mar" => "Março",
"language_apr" => "Abril",
"language_may" => "Maio",
"language_jun" => "Junho",
"language_jul" => "Julho",
"language_aug" => "Agosto",
"language_sep" => "Setembro",
"language_oct" => "Outubro",
"language_nov" => "Novembro",
"language_dec" => "Dezembro",
"language_su" => "Su",
"language_mo" => "Mo",
"language_tu" => "Tu",
"language_we" => "We",
...
"language_distributor_submit" => "Enviar",
"language_distributor_search_btn" => "Busca",
...
"language_distributor_search" => "Busca...",
"language_distributor_dashboard" => "Painel de Controle",
"language_distributor_profile" => "Perfil",
...
"language_distributor_password" => "Senha",
...
"language_distributor_venue_added_success_msg" => "Os detalhes do local foram salvos com sucesso",
"language_distributor_venue_added_failure_msg" => "_Venue insertion error",
"language_distributor_venue_already_available_msg" => "_The venue name already exists.",
"language_distributor_venue_firstname_check_error" => "O Primeiro Nome não pode conter números ou caracteres especiais",
"language_distributor_venue_lastname_check_error" => "O Sobrenome não pode conter números ou caracteres especiais",
"language_distributor_venue_updated_success_msg" => "Os detalhes do local foram atualizados com sucesso.",
"language_distributor_venue_updated_failure_msg" => "_Venue updating error",
"language_distributor_venue_deleted_success_msg" => "O local selecionado foi excluído com sucesso.",
"language_distributor_venue_deleted_failure_msg" => "O local está sendo usado para um evento de exame e não pode ser excluído. Aguarde até que o evento de exame tenha ocorrido e, em seguida, exclua.",
"language_distributor_label_distributor" => "_Distributor",
"language_distributor_label_venue_name" => "_Venue Name",
"language_distributor_label_composite_id" => "T_est ID",
"language_distributor_label_firstname" => "Primeiro nome",
...
"language_distributor_add_event_success_msg" => "Evento adicionado com sucesso",
...
"language_distributor_add_event_end_time_great_msg" => "O horário de término deve ser após o horário de início",
...
"language_distributor_event_please_choose_event" => "Por favor, escolha Eventos.",
"language_distributor_event_please_choose_venue" => "Por favor, escolha o local.",
"language_distributor_event_cannot_be_added" => "O evento não pôde ser adicionado, porque há outro evento já agendado.",
...
"language_questionarie2_label_accessenglish_title" => "Você acessa qualquer um dos seguintes utilizando inglês regularmente (uma ou duas vezes por semana)? Selecione todas as opções aplicáveis.",
...
"language_questionarie2_please_enter_value" => "Por favor, insira um valor",
...
"language_school_order_no_order" => "_No orders have been made. Please click the Order Codes button to make an order.",
...
"language_school_access_details_hello" => "Oi ",
...
"language_school_access_details_howtoaccess_primary_description2" => "2. Na próxima página, digite o nome de usuário e senha abaixo, na seção chamada Under 16 years",
"language_school_access_details_howtoaccess_primary_description3" => "3. Siga as instruções que estão na tela para fazer o teste",
"language_school_access_details_footer_greeting" => "Boa sorte com seu aprendizado!",
...
"language_admin_banner_name0" => "Realizável",
"language_admin_banner_description0" => "Cursos e testes de inglês",
"language_admin_banner_name1" => "Flexível",
"language_admin_banner_description1" => "Aprendizagem online",
"language_admin_banner_name2" => "de Alto Nível",
"language_admin_banner_description2" => "Padrões",
"language_admin_banner_name3" => "Custo Acessível",
"language_admin_banner_description3" => "Cursos e testes de inglês",
...
"about.title" => "Sobre Quem Somos",
"about.content" => "_This is about us page.",
"register_failed" => "_Register failed",
"login_failed" => "_Login failed",
"reset_user_not_found" => "_User not found",
"reset_token_expired" => "_Reset token expired",
"reset_token_check_failed" => "_Reset token doesn't match",
"language_beginner" => "Iniciante",
"language_lower_intermediate" => "Pré-Intermediário ",
"language_intermediate" => "Intermediário",
"language_advanced" => "_Advanced",
"language_stage_1" => "Etapa 1",
"language_stage_2" => "Etapa 2",
"language_stage_3" => "Etapa 3",
"language_stage_4" => "Etapa 4",
"language_step_forward" => "Step Forward",
"language_step_up" => "Step Up",
"language_step_ahead" => "Step Ahead",
"language_step_higher" => "Step Higher",
"language_site_you_will_be_able_to" => "Você poderá",
"language_site_greet_other_people" => "Cumprimentar e se apresentar à outras pessoas",
"language_site_talk_about_yourself" => "Falar sobre você e sua família",
"language_site_ask_for_directions" => "Perguntar por direções",
"language_site_write_basic_sentence" => "Escrever frases básicas sobre você, sua família e seu trabalho",
"language_site_talk_about_everyday" => "Falar sobre pessoas e lugares comuns",
"language_site_talk_about_hobbies" => "Falar sobre seus hobbies, gostos e frustrações",
"language_site_describe_and_compare" => "Descrever e comparar coisas",
"language_site_talk_about_future" => "Falar sobre planos futuros e fazer planos para eventos sociais",
"language_site_express_your_opinion" => "Expressar sua opinião",
"language_site_talk_about_work" => "Falar sobre trabalho, hobbies, viagens e eventos",
"language_site_desc_people" => "Descrever pessoas e lugares",
"language_site_read_a_short" => "Ler uma história ou um artigo",
"language_site_talk_and_write" => "Falar e escrever em inglês sem cometer muitos erros",
"language_site_write_simple_emails" => "Escrever e-mails, histórias ou artigos simples",
...
"language_site_booking_continue_btn" => "Continuar",
...
"language_site_booking_tabs2" => "Cadastre-se ou faça o login",
"language_site_booking_tabs3" => "Obtenha seu nível certo",
"language_site_booking_tabs4" => "_Confirm and pay",
"language_site_booking_tabs5" => "Comece a aprender!",
"language_pls_enter_value" => "Por favor, insira um valor",
"language_site_booking_tabs_m1" => "Digite o código",
"language_site_booking_tabs_m2" => "Cadastre-se ou faça seu log-in",
"language_site_booking_tabs_m3" => "Get the right CATs Step",
"language_site_booking_tabs_m4" => "Comece a aprender!",
"language_site_booking_tabs_m3b" => "_StepCheck test",
"language_site_booking_tabs_m3s" => "_Speaking test",
"language_site_booking_tabs_m4b" => "_Result",
"language_site_booking_screen_m1_title" => "Digite o código",
"language_site_booking_screen_m1_label" => "Código",
"language_site_booking_screen_m1_content" => "Antes de começar, você precisa fazer o log-in (usuários existentes) ou criar uma conta (novos usuários).",
"language_enter_code_description" => "No campo abaixo, digite o código de 9 dígitos que você recebeu.",
...
"language_site_booking_screen_m1_enter_code_error" => "Digite o código.",
"language_site_back_to_homepage" => "Voltar à Página Principal",
"language_site_booking_screen_m2_terms_service" => "Eu aceito os Termos de Uso que estão disponíveis <a href='#' id='terms' data-toggle='modal' data-target='#termsModal'> aqui </a>.",
"language_site_booking_screen_m1_invalid_code" => "O código digitado não é válido. Por favor, verifique o código cuidadosamente e tente novamente. Se você continuar tendo problemas, entre em contato com sua organização.",
"language_site_booking_screen_m1_already_used_code" => "Este código já foi utilizado!",
"language_site_booking_tabs_m1new" => "Iniciar",
"language_site_booking_screen_m1_title_one" => "Tenho 16 anos de idade ou mais",
"language_site_booking_screen_m1_title_two" => "Tenho menos de 16 anos de idade",
"language_site_booking_screen_m1_content_two" => "Enter the username and password which your supervisor has given you.",
"language_site_booking_screen_m1_username_label" => "Nome de usuário",
"language_site_booking_screen_m1_password_label" => "Senha",
"language_primary_username" => "Username",
"language_primary_password" => "Senha",
"language_primary_login_failure_msg" => "_Invalid username/password",
"language_linear_headphone_title" => "_Headphones Test",
"language_linear_headphone_put_on_title" => "_Please put on your headphones",
"language_linear_headphone_put_on_proceed_title" => "_Click 'Continue' to start the headphones test.",
"language_linear_headphone_step1" => "_Step 1",
"language_linear_headphone_step2" => "_Step 2",
"language_linear_headphone_please_click_before" => "_Please click",
"language_linear_headphone_please_click_after" => "_to play the test sound.",
"language_linear_headphone_voulume_adjust" => "_Adjust the volume on your device, if needed.",
"language_linear_keep_quiet_title" => "_The test will begin soon. Please sit quietly.",
"language_linear_welcome_title" => "_This is the",
"language_linear_listening_title" => "_There are 21 Listening questions and 19 Reading questions.",
"language_linear_hear_sound_title" => "_Before each Listening question you will hear this sound",
"language_linear_beep" => "_[BEEP]",
"language_linear_hear_sound_twice_title" => "_You hear each Listening question twice.",
"language_linear_can_you_hear_confirm_title" => "_Can you hear the test sound clearly?",
"language_linear_continue_btn" => "Continuar",
"language_linear_start_btn" => "_Start",
"language_linear_next_btn" => "_Next",
"language_linear_finish_btn" => "_Finish",
"language_linear_can_you_hear_confirm_yes_btn" => "_Yes",
"language_linear_can_you_hear_confirm_no_btn" => "_No",
"language_linear_can_you_hear_confirm_repeat_message" => "_Please repeat Step 1 and Step 2.",
"language_linear_can_you_hear_confirm_ok_btn" => "_Ok",
"language_linear_timer_seconds" => "_seconds",
"language_linear_timer_second" => "_second",
...
"language_site_booking_screen1_select_country" => "Por favor, selecione",
...
"language_site_booking_screen1a_header2_content" => "_You need to attend a supervised venue to take your test at your selected city ||CITY|| and you will be able to book your test on this website once you have started your course.",
...
"language_site_booking_screen2_title" => "Cadastre-se ou faça seu log-in",
"language_site_booking_screen2_description" => "_If you are a new user and have never taken CATs before you need to Sign up. If you have taken CATs before choose Login. If you can't remember your login details, click Forgot Password?",
"language_site_booking_screen2_tab_signup" => "Cadastre-se",
"language_site_booking_screen2_tab_login" => "Faça seu log-in",
"language_site_booking_screen2_sign_up_with" => "Ou cadastre-se com:",
"language_site_booking_screen2_login_with" => "_Or Login with:",
...
"language_site_booking_screen2_label_first_name" => "Primeiro nome",
"language_site_booking_screen2_label_second_name" => "Sobrenome",
"language_site_booking_screen2_label_email_address" => "Endereço de e-mail",
"language_site_booking_screen2_label_confirm_email_address" => "Confirmar Endereço de e-mail",
"language_site_booking_screen2_label_terms" => "_Terms",
"language_site_booking_screen2_label_email_username_address" => "_Email/Username",
"language_site_booking_screen2_label_email_confirm_email_mismatch" => "A conta de E-mail e o seu E-mail de Confirmação não são idênticos",
...
"language_site_booking_screen2_label_password" => "Senha",
"language_site_booking_screen2_label_confirm_password" => "Confirmar Senha",
"language_site_booking_screen2_label_current_password" => "senha atual",
"language_site_booking_screen2_label_new_password" => "Nova senha",
"language_site_booking_screen2_label_confirm_new_password" => "Confirme a nova senha",
...
"language_site_booking_screen2_forgot_password" => "Esqueci Minha Senha?",
"language_site_booking_screen2_password_check" => "A {field} deve conter no mínimo 8 caracteres.",
"language_site_booking_screen2_firstname_check" => "O campo do {field} não pode conter números ou caracteres especiais",
"language_site_booking_screen2_orgname_check" => "Caracteres especiais permitidos são: @. # $% ^ & + =) (- ",
...
"language_site_booking_screen2_register_failure_msg" => "_Please provide all mandatory information",
"language_site_booking_screen2_login_success_msg" => "_Login successful!",
"language_site_booking_screen2_login_failure_empty_msg" => "_The email and/or password are not entered.",
"language_site_booking_screen2_login_failure_msg" => "O e-mail/ nome de usuário e/ou a senha não está correto.",
...
"language_site_booking_screen3_title" => "Obtenha seu nível certo",
...
"language_site_booking_screen3a_title" => "Obtenha seu nível certo – Resultados",
"language_site_booking_screen3a_description" => "O nível recomendado prá você é ",
"language_site_booking_screen3a_header" => "_Recommended level",
"language_site_booking_screen3a_cefr_above_level_title" => "_Well done! Your level of proficiency is currently ##CEFR_HIGH##.",
...
"language_site_booking_screen3b_option_select_city" => "Por favor, selecione",
...
"language_site_booking_you_will_be_able_to" => "Você poderá",
"language_site_booking_a1_text1" => "Cumprimentar e se apresentar à outras pessoas.",
"language_site_booking_a1_text2" => "Falar sobre você e sua família",
"language_site_booking_a1_text3" => "Perguntar por direções",
"language_site_booking_a1_text4" => "Escrever frases básicas sobre você, sua família e seu trabalho",
"language_site_booking_a1_text5" => "_Understand information about prices, numbers and times",
"language_site_booking_a2_text1" => "Falar sobre pessoas e lugares comuns",
"language_site_booking_a2_text2" => "Falar sobre seus hobbies, gostos e frustrações",
"language_site_booking_a2_text3" => "Descrever e comparar coisas",
"language_site_booking_a2_text4" => "Falar sobre planos futuros e fazer planos para eventos sociais",
"language_site_booking_a2_text5" => "Expressar sua opinião",
"language_site_booking_b1_text1" => "Falar sobre trabalho, hobbies, viagens e eventos",
"language_site_booking_b1_text2" => "Descrever pessoas e lugares",
"language_site_booking_b1_text3" => "Ler uma história ou um artigo",
"language_site_booking_b1_text4" => "Falar e escrever em inglês sem cometer muitos erros",
"language_site_booking_b1_text5" => "Escrever e-mails, histórias ou artigos simples",
"language_site_booking_screen_2p_text1" => "_Welcome to CATs",
"language_site_booking_screen_2p_text2" => "_Your supervisor has the result from your test and will help explain this to you.",
"language_site_booking_screen_2p_text3" => "_You can learn on a tablet with the CATs Primary app. To get the CATs Primary app, your parent or supervisor needs to go to the Google Play Store or the Apple App Store and search for CATs Primary English. Once the app is downloaded you can enter your username and password from the sheet you were given by your supervisor.",
"language_site_booking_screen_2p_text4" => "_You can learn with the CATs website at www.primary.cats.eduction. Enter the username and password from the sheet you were given by your supervisor.",
"language_site_booking_screen_2p_text5" => "_If you need any help, let your supervisor know.",
"language_site_booking_screen_2p_text6" => "_Good luck with your learning!",
...
"form_validation_required" => "O campo do {field} é obrigatório.",
"form_validation_isset" => "The {field} field must have a value.",
"form_validation_valid_email" => "O campo {field} deve conter um endereço de e-mail válido.",
...
"form_validation_min_length" => "O campo {field} deve ter pelo menos {param} caracteres.",
"form_validation_max_length" => "O campo do {field} não pode exceder {param} caracteres.",
...
"form_validation_matches" => "O {field} campo não corresponde ao a {param} campo.",
...
"site_label_drop_profile" => "Perfil",
"site_label_drop_logout" => "Log-out",
"home.title" => "Home",
"home.content" => "This is home page.",
"home.title_content" => "Welcome to the CATs Pilot for Malaysia",
"start_learning" => "Start Learning",
"home_why_learn_with_cats" => "Assista nosso vídeo informativo de como aprender com o Programa CATs",
"name" => "Name",
"email" => "E-mail",
"country" => "Country",
"message" => "Message",
...
"lsetting_modal_header_desc" => "Sucesso - Nível CATs Alocado
    Antes de começar, precisamos saber qual é o idioma de sua preferência para que possamos fornecer a versão correta do conteúdo de aprendizagem. Se o idioma não estiver disponível, selecione English.",
...
"lsetting_please_select" => "Selecione",
"lsetting_please_select_language" => "Please select language",
"lsetting_success_msg" => "Language settings updated",
"lsetting_label_language" => "Idioma de Preferência do Aplicativo",
"lsetting_label_gender" => "Sexo",
"lsetting_label_dob" => "Data de Nascimento",
"lsetting_label_reason" => "Razões para aprender inglês. Selecione todas as opções aplicáveis.",
"lsetting_label_noofyear" => "Quando você começou a aprender inglês?",
"lsetting_label_accessenglish_title" => "Você acessa qualquer um dos seguintes utilizando inglês regularmente (uma ou duas vezes por semana)? Selecione todas as opções aplicáveis.",
"lsetting_label_accessenglish" => "Access",
"lsetting_label_learninginweek_title" => "Quanto tempo você utiliza estudando inglês por semana em seu próprio tempo?",
"lsetting_label_learninginweek" => "Spending",
"lsetting_label_difficultinenglish_title" => "Quão difícil você acha que é aprender os seguintes (1 é muito difícil e 5 é muito fácil)",
...
"lsetting_label_gender_male" => "Masculino",
"lsetting_label_gender_female" => "Feminino",
"lsetting_label_gender_not_known" => "Não consta",
"lsetting_label_gender_not_applicable" => "Não é aplicável",
...
"lsetting_label_ans_following_text" => "Responda as seguintes perguntas sobre você mesmo .",
...
"language_email_exists" => "O %s inserido já existe. Por favor, faça o log-in ou clique no link ‘Esqueci minha Senha’ na página de log-in.",
...
"login" => "Log-in",
"gove_min_edu" => "Governos e Ministérios de Educação",
"employers" => "Employers",
"schools" => "Schools",
"about_us" => "Sobre Quem Somos",
"contact_us" => "Contact us",
"terms_and_cond" => "Termos de Uso e Proteção de Dados",
"data_prot" => "Data Protection",
"accessibility" => "Accessibility",
"help" => "Ajuda",
"more_information" => "Mais informações",
"booked_success" => "You have successfully booked and paid for your CAT.",
"language_dashboard" => "Painel de Controle",
"language_dashboard_welcome" => "Bem-vindo",
"language_dashboard_select_product" => "Select a Product",
"language_dashboard_learning_and_preparation" => "Aprendizagem e Preparação",
"language_dashboard_learning_test" => "nível",
"language_dashboard_learning_as_you_study" => "Durante seus estudos, você terá a chance de praticar todas as competências, a gramática e o vocabulário necessário para o teste. Você pode estudar utilizando um tablet ou um smartphone",
"language_dashboard_learning_download_the_practice_app" => "Faça o download do aplicativo CATs para o seu tablet ou iPad",
"language_dashboard_practice_tests" => "Simulador de Testes",
"language_dashboard_you_can_take" => "Você pode fazer dois testes práticos para ajudá-lo a se preparar para o exame final do nível ",
...
"language_dashboard_you_will_need" => "Você precisará das informações abaixo (Número do exame e Número do candidato) para fazer os Simuladores de Testes",
...
"language_dashboard_practice_test" => "Simulador de Teste ",
"language_dashboard_test_number" => "Número do Teste",
"language_dashboard_candidate_number" => "Número do Candidato",
"language_dashboard_you_can_take_your" => "Você pode fazer seus Simuladores de Testes on-line utilizando seu computador através do navegador Chrome. Visite: ",
"language_dashboard_or_download_the" => "ou baixe o aplicativo CATs para fazer os Testes em seu tablet ou iPad",
"language_dashboard_practice_test_title_a" => "Seu desempenho geral",
"language_dashboard_practice_test_description_green" => "Apto para seguir em frente. Com base no seu desempenho neste Simulador de Teste, recomendamos que você faça o segundo Simulador de Teste ou o Exame Final",
"language_dashboard_practice_test_description_orange" => "Precisa praticar mais. Com base no seu desempenho neste Simulador de Teste, recomendamos que você retorne aos materiais de preparação antes de fazer o segundo Simulador de Teste ou o Exame Final.",
"language_dashboard_practice_test_title_b" => "Seu desempenho em cada etapa",
"language_dashboard_practice_test_icon_a" => "Bem",
"language_dashboard_practice_test_icon_b" => "Precisa praticar mais",
"language_dashboard_practice_test_table_label_part" => "Parte",
"language_dashboard_practice_test_table_label_skills" => "Habilidade(s) testada(s)",
"language_dashboard_practice_test_table_label_performance" => "Desempenho",
"language_dashboard_practice_test_listening" => "Listening",
"language_dashboard_practice_test_reading" => "Leitura",
"language_dashboard_practice_test_writing" => "Escrita",
"language_dashboard_practice_test_speaking" => "Fala",
"language_dashboard_book_your_test" => "Agendar seu exame",
"language_dashboard_to_complete_the" => "Para completar o nível do",
"language_dashboard_level_you_will" => "você precisará fazer um exame online em um de nossos Centros de Avaliação credenciados em uma data específica. Clique em  Selecionar Exame  para ver locais e datas disponíveis para concluir o processo de agendamento.",
"language_dashboard_book_test" => "Agendar seu exame",
"language_dashboard_your_result" => "resultado",
"language_dashboard_your_final_result" => "Final Test Result",
"language_dashboard_your_results" => "Seus resultados",
"language_dashboard_see_how_well" => "Veja como se saiu nos Simuladores de Teste e no Exame Final do",
"language_dashboard_see_how_well_higher" => "See how well you have done in the final test for",
"language_dashboard_you_can_see" => "Você pode ver em quais competências você  tem mais facilidade e em quais áreas você precisa praticar mais",
"language_dashboard_final_test" => "Exame Final",
"language_dashboard_not_taken" => "Ainda não foi feito",
...
"language_dashboard_continue" => "Continuar",
...
"language_dashboard_book_cats" => "Iniciar",
"language_events_no_test_event_found" => "Nenhum Evento de Exame foi encontrado correspondendo aos seus critérios. Por favor, selecione um mês ou local diferente e tente novamente.",
"language_dashboard_practice_test_title" => "Simulador de Teste ",
...
"language_dashboard_practice_text2" => "You will need the Test Number and Candidate Number below to take the practice tests. The numbers are available soon after registering, usually within 30 minutes.",
"language_dashboard_practice_available_soon" => "Disponível em breve!",
"language_dashboard_practice_label_test_number" => "Número do Teste",
"language_dashboard_practice_label_candidate_number" => "Número do Candidato",
...
"language_search_events_test_events" => "Eventos de Exames ",
"language_search_events_month" => "Mês",
"language_search_events_location" => "Local",
"language_search_events_search" => "Busca",
"language_search_events_sortby" => "Sort By",
"language_search_events_date" => "Date",
"language_search_events_please_select" => "Selecione",
"language_search_events_all" => "Todos",
...
"language_search_events_back_to_dash" => "Voltar ao Painel de Controle",
...
"language_initial_title" => "Avaliação inicial",
"language_final_title" => "Test completed",
"language_recommend_to_next" => "We recommend that you start at level: ",
"language_initial_message" => "Por favor, responda todas as perguntas. Após esta página, as instruções para responder às perguntas serão todas em inglês. Se você não conseguir entende-las, não se preocupe. Faça apenas o que você souber.",
"language_start_test_btn" => "Iniciar a avaliação",
...
"language_warning_back_button_pressed" => "Warning - using the back button will end the test. All responses will be lost and you will need to re-start the test. Click Ok to end the test (you will need to restart it again at another time) or Cancel to resume the test.",
...
"password_setup_password" => "Senha",
"langugage_account_suspended" => "Account suspended temporarily.",
"language_dashboard_more_info_description" => "Faça o download das fichas informativas abaixo que contêm mais detalhes sobre os diferentes níveis e serviços do Programa CATs:",
...
"language_admin_language" => " Idioma ",
...
"language_site_booking_screen3_description" => "Muito bem! Você agora criou sua conta. Você já está quase pronto, mas precisamos ajudá-lo a definir o nível certo de CATs. Agora você fará uma pequena avaliação que levará cerca de 15 a 20 minutos. Por favor, verifique se você dispõe de tempo suficiente para completar a avaliação em apenas uma sessão.",
...
"language_site_booking_screen2a_primary_placment_description" => "_You now need to take a short test which will take about 30 minutes and help you start at the right level of CATs Step Primary. If you have any questions, ask your supervisor. Good luck!",
...
"language_site_booking_screen_m2_description" => "Sucesso! O código que você inseriu foi fornecido pela(o) ##SCHOOL_NAME##. Se você é um novo usuário e nunca fez a pré-avaliação CATs, você precisará se inscrever.

 Se você já o fez, cliquen em Login. Se você não consegue lembrar seus dados do login, clique em Esqueci Minha Senha.?
",
"language_dashboard_learning_you_have_45" => "Você tem 45 horas de materiais de aprendizado on-line do Programa CATs para ajujá-lo a se preparar para o exame ao final do",
"language_dashboard_learning_download_the_cats_app" => "Para acessar o curso, baixe o aplicativo CATs no seu tablet, iPad ou smartphone",
...
"language_site_booking_screen_m2_front_terms_service" => "_I agree to the Terms of Use which are available <a href='".base_url()."/en/pages/terms_conditions' target='_blank'>here</a>.",
"language_site_booking_screen2a_primary_placment_title" => "_CATs Step Primary Test",
"forgot.description" => "Digite o endereço de e-mail que você utilizou para criar sua conta CATs e um e-mail será enviado para sua caixa de entrada. Basta seguir o link e você poderá redefinir sua senha. Se você não recebeu o e-mail, verifique sua pasta de spam/lixo eletrônico para verificar se ele não foi encaminhado prá lá. Às vezes é necessário adicionar o endereço de e-mail à sua lista de contatos primeiro para garantir a chegada do e-mail contendo o link. O endereço é: noreply@catsstep.education.",
"lsetting_modal_header_title" => "Sucesso - Nível CATs Step Alocado!",
...
"language_dashboard_see_other_cats" => "Selecione seu Plano CATs Step",
...
"language_dashboard_purchase_using_token_successmsg" => "Você selecionou seu Plano CATs Step com sucesso seu Exame de Nível CATs Step!",
...
"language_admin_higher_tds_reading_menu" => "Reading ability lookup - CATs Step Step",
...
"language_school_access_details_howtoaccess_title" => "Como acessar CATs Step pela primeira vez",
...
"language_school_access_details_howtoaccess_primary_description1" => "1. Vá para www.catsstep.education e clique no botão  Get Started.",
"language_school_access_details_usingcats_title" => "Usando CATs Step para aprender inglês",
"language_school_access_details_usingcats_primary_description1" => "Depois de fazer o teste, você pode começar a aprender com CATs Step. Você pode aprender em um tablet com o aplicativo CATs Step ou você pode ir para o site CATs Step às www.catsstep.education.",
...
"language_school_access_details_usingcats_core_description1" => "Depois de fazer o teste, você pode começar a aprender com CATs Step. Você pode aprender em um
    tablet ou celular com o aplicativo CATs ou você pode ir para o site CATs, faça o login com o seu
    Nome de usuário e senha e clique no botão
     Preparation and practice (Preparação e prática).",
...
"language_admin_placement_configs_inactive" => "The institute has been Inactivated successfully.",
