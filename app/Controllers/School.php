    ...
    public function generateAccessDetailsPdf($accessDetails = FALSE) {
        ...
        if ($accessDetails) {
			...
			<html>
                ...
                <body style="margin: 0 auto; padding: 0;box-sizing: border-box;text-align: left;font-size: 14px; font-family: \'Comic Sans Regular\', \'Comic Sans Bold\', cursive, sans-serif; line-height:14px;">';
							...
							<td>
								 <table width="100%" >
									<tbody>
										...
										<tr>
										<td style="font-family : \'Comic Sans Regular\', cursive, sans-serif;padding: 5px 0px 5px;">' . lang('app.language_school_access_details_intro') . '</td>
										</tr>
										<tr>
											<td>
											<table>
											<tr>
												  <td style="padding: 5px 0px;font-family: courier, courier new, serif;font-size:20px;text-align:right;"><strong>' . lang('app.language_school_access_details_username') . ': </strong></td>
												  <td style="padding: 5px 0px;font-family: courier, courier new, serif;font-size:20px;text-align:left;"><strong>' . $accessdetail->username . '</strong></td>
												</tr>
											<tr>
												  <td style="padding: 5px 0px;font-family: courier, courier new, serif;font-size:20px;text-align:right;"><strong>' . lang('app.language_school_access_details_password') . ': </strong></td>
												  

												  <td style="padding: 5px 0px;font-family: courier, courier new, serif;font-size:20px;text-align:left;"><strong>' . $this->encrypter->decrypt(base64_decode($accessdetail->password_visible))  /* $accessdetail->password_visible*/ . '</strong></td>
												</tr>	
											</table>
											</td>
										</tr>
										...
										<td>
											<table style="font-size: 16px; border:1px solid #ccc; padding:10px 20px;margin-top: 20px;width:100%;border-radius: 10px;">
												<tbody style="font-size: 14px;">
													<tr><td style="font-family : \'Comic Sans Bold\', cursive, sans-serif; padding:5px 0 10px;font-weight: bold;font-size: 16px;">' . lang('app.language_school_access_details_howtoaccess_title') . '</td></tr>
													<tr>
													<td style="font-family : \'Comic Sans Regular\', cursive, sans-serif;padding: 5px 0px 10px;">' . lang('app.language_school_access_details_howtoaccess_primary_intro') . '</td>
													</tr>
													<tr>
													...
													<tr>
														<td style="font-family : \'Comic Sans Regular\', cursive, sans-serif;padding: 5px 20px;">' . lang('app.language_school_access_details_howtoaccess_primary_description3') . '</td>
													</tr>
													...
													<tr>
														<td style="font-family : \'Comic Sans Regular\', cursive, sans-serif;padding: 5px 0px 5px;">' . lang('app.language_school_access_details_usingcats_primary_description1') . '</td>
														</tr>
														<tr>
														...
														<tr>
															<td style="font-family : \'Comic Sans Regular\', cursive, sans-serif;padding: 5px 0px 10px;font-size: 16px;">' . lang('app.language_school_access_details_footer_greeting') . '</td>
														</tr>
												</tbody>
											</table>
										</td>
										...
										<td>
											<table style="font-size: 16px; border:1px solid #ccc; padding:10px 20px;margin-top: 20px;width:100%;border-radius: 10px;">
												<tbody style="font-size: 14px;">
													...
													<tr><td style="font-family : \'Comic Sans Bold\', cursive, sans-serif;padding:15px 0 10px;font-weight: bold;font-size: 16px;">' . lang('app.language_school_access_details_usingcats_title') . '</td></tr>
													<tr>
