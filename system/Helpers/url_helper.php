...
if (! function_exists('site_url')) {
    ...
    function site_url($relativePath = '', ?string $scheme = null, ?App $config = null): string
    {
        ...
        $withoutlan = (new App())->baseURL;
        $lang = (get_Cookie('lang')) ? get_Cookie('lang') : 'en';
        $orginal = $withoutlan.$lang.'/';
        return str_replace($withoutlan,$orginal, URI::createURIString($scheme ?? $uri->getScheme(), $uri->getAuthority(), $uri->getPath(), $uri->getQuery(), $uri->getFragment()));
